    ...
    <div id="prodiv" style="width: 100%; margin: 0 auto;">
        ...
        <table class="table" border="0" cellspacing="0" cellpadding="5" style="width: 100%;">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th>District</th> --}}
                                    <th>Sports </th>
                                    <th>Sports Competition Details</th>
                                    {{-- <th>Position / Medal</th>
                                    <th width="20%">Period Of Competition</th> --}}
                                    <th> Application Status</th>
                                    {{-- <th>Query Status</th> --}}
                            ...
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td> @if(count($data)>0)
                                        ...
                                        <b>Sports Competition Name:</b> {{sportEventName($item->sport_achievement)}}  <br>
                                        <b>Position / Medal/: </b>{{$item->sport_achievement_position}} <br>
                                        <span><b>Period Of Competition: </b> {{$item->competition_from_date}} to {{$item->competition_to_date}}</span> <br>
                                ...
                                <tr >
                                    ...
                                    <td> @if(count($data)>0)
                                        @foreach($data as $key=>$item)
                                        @if($key!=0)<br><hr>@endif
                                        <b>Sports Competition Name:</b> {{sportNEventName($item->sport_event)}}  <br>
                                        <b>Position / Medal/: </b>{{$item->medal}}<br>
                                        <span><b>Period Of Competition: </b> {{$item->competition_from_date}} to {{$item->competition_to_date}}</span> <br>
              ...
              <tfoot class="dn" >
                                        <tr >
                                            <td colspan="17"  style="border:0 !important; height:30px;">&nbsp;</td>
                                        </tr>
                                    </tfoot>
      ...
      <script>
        function PrintDoc() {
            ...
            popupWin.document.write('<html><head><style>body{font-family:Arial; counter-reset: page;} .noprint{display: none;} table{width:100%; border-collapse:collapse;} .table tr th, .table tr td{border:1px solid #000; padding:3px 3px; font-size: 10pt;} @page {size: A4 landscape; margin: 10pt 10pt 20pt 10pt;}</style></head><body onload="window.print()">')
