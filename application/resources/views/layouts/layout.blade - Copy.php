...
<head>
	...
	<link href="{{ asset('/public/admin') }}/css/font.css" rel='stylesheet'/>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-1 b-right">
						<img src="{{ url('/public') }}/admin/images/logo.png" alt="" class="dash-logo dash-resp" style=" max-width: 95px; "/>
					</div>
					<div class="col-md-11">
	...
	<script>
		function get_event(id,type) {
			...
			$.ajax({
				...
				data: {
					comp:comp,event_type:event_type,type:type
				},
