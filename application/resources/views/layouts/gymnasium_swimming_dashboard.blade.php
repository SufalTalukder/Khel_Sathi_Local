              ...
              <nav class="navbar navbar-expand-lg topmenu">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item active"><a class="nav-link" href="{{route('gymnasium_swimming_dashboard')}}"><span class="icons icon-speedometer"></span> Dashboard </a></li>
                    <li class="nav-item"><a href="javascript:void();" class="profileicon"> <span class="icons icon-user"></span> </a>
                      <div class="sidebar">
                        <div class="profiletitle"><?php echo ucfirst(Auth::guard('GymnasiumSwimming')->user()->name);?><span class="text-uppercase">Applicant</span> <span>Last Login : <?php echo date("d-m-Y ", strtotime(Auth::guard('GymnasiumSwimming')->user()->last_login));?> </span></div>
                        <div class="scrollwrap">
                          <div class="nano-content">
                            <ul class="navsidebar">
                              <li class="nav-item"><a href="{{route('gymnasium_swimming_changepassword')}}"><span class="icons icon-lock"></span> Change Password</a> </li>
                            </ul>
                          </div>
                        </div>
                        <div class="logoutbutton"><a href="{{ route('gymnasium_swimming_logout') }}"><span class="fas fa-power-off"></span>&nbsp;&nbsp;Logout</a></div>
                      </div>
                    </li>
                  </ul>
                </div>
