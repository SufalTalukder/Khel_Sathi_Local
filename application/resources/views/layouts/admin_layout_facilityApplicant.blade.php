...
<head>
  ...
  <link href="{{ url('admin') }}/css/responsive.css" rel="stylesheet" media="all" />
  ...
  <div class="contentwraper">
    <header class="header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-2 col-md-1 b-right"> <img src="{{ url('admin') }}/images/dash-logo.png" alt="" class="dash-logo" /> </div>
...
<script type="text/javascript">
  ...
  if ($(".edit_req")[0]){
    $(".gym_req").attr("required", false);
          $(".adult_req").attr("required", false);
          $(".mini_req").attr("required", false);
...
<script type="text/javascript">
   function getfileextimage(value, id) {
      ...
      if (
        ...
        $("#File" + id).val("");
        $("#sign").attr("src", "");
        error("Please Upload File in image Format.");
