                        ...
                        <div class="bhoechie-tab-menu">
                            <div class="list-group">
                                <a class="list-group-item active" style="width: 100%;">
                                    ...
                                    Application for Nomination for Rani Laxmibai Award
                                </a>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" id="prodiv">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" align="center"
                                                            ...
                                                            <div
                                                                ...
                                                                <div style="font-size: 18px; font-weight: bold;">Nomination
                                                                    Form to Seek Reward from Government of UP <br>उ0प्र0
                                                                    सरकार से पुरस्कार प्राप्त करने हेतु नामांकन प्रपत्र
                                                                </div>
                                                                <div style="font-size: 18px; font-weight: bold;">वित्तीय
                                                                    वर्ष 2025-26 में रानी लक्ष्मीबाई पुरस्कार 2024-25 हेतु
                                                                    आवेदन पत्र</div>
                                                ...
                                                @foreach ($articles as $article)
                                                    ...
                                                    <div class="d-flex justify-content-between bg-light p-2">
                                                        <div>
                                                            Is Applicant Physically Challenged ? / क्या आवेदक शारीरिक रूप से
                                                            अक्षम है?-
                                                            <b>{{ $article->is_phy_handicapped == '1' ? 'YES' : 'NO' }}</b>
                                                        </div>
                                                        @if ($article->is_phy_handicapped == 1)
                                                            <div>
                                                                Medical Certificate / चिकित्सा प्रमाणपत्र
                                                                <a href="{{ url('storage/award', $article->phy_handi_docs) }}"
                                                                    target="_blank">
                                                    ...
                                                    <p @if ($article->amount_release_status != 1) style="display: none" @endif
                                                        class="bg-light"><strong>Amount
                                                            Released/धनराशि :-</strong>
                                                        <b>{{ $article->amount_release }}</b>
                                                    </p>
                                                    ...
                                                    <table id="dataTable" class="table table-bordered" border="1"
                                                        ...
                                                        <tr>
                                                            <td style="width: 20%;"><b>Applicant's Full Name<br>आवेदक का
                                                                    पूरा नाम</b></td>
                                                            <td>{{ $article->fullname }}</td>
                                                            <td><b>Which Sport did/do you play?<br>कौन सा खेल खेलते
                                                                    थे/हैं?</b></td>
                                                            <td>{{ $article->sport_name }}</td>
                                                            <td style="width: 25%;" colspan="2" rowspan="5">
                                                                <b>Photograph of Applicant's<br>आवेदक की फोटो</b><br />
                                                        ...
                                                        <tr>
                                                            <td><b>Highest Educational Qualification<br>उच्चतम शैक्षणिक
                                                                    योग्यता</b></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td colspan="2"><b>Mobile No. (registered with Bank
                                                                    Account)<br>मोबाइल नंबर (बैंक खाते के साथ जो पंजीकृत
                                                                    है)</b></td>
                                                            <td>{{ $article->mobile_registered_in_bank }}</td>
                                                            <td colspan="2"><b>Any other relevant information applicant
                                                                    wants to furnish?<br>कोई अन्य प्रासंगिक जानकारी आवेदक
                                                                    निर्दिष्ट करना चाहते हैं?</b></td>
                                                        ...
                                                        @foreach ($other_achievement as $item)
                                                            <tr>
                                                                <td><b>Name of the Achievement<br>उपलब्धि का नाम</b></td>
                                                                <td>{{ $item->achievement_name }}</td>
                                                                <td><b>Documents<br>दस्तावेज</b></td>
                                                                <td colspan="3">
                                                                    @if ($item->achievement_docs != '')
                                                                        <!-- <a href="{{ url('storage/laxmibai_award', $item->achievement_docs) }}"
                                                                                            target="_blank">
                                                                                            <span
                                                                                                class="btn btn-success btn-xs">Uploaded</span>
                                                                                        </a> -->
                                                                        <a href="{{ url('storage/laxmibai_award', $item->achievement_docs) }}"
                                                                            download target="_blank">
                                                                            <!-- <span class="btn btn-success btn-xs"><i
                                                        ...
                                                        <tr>
                                                            <td colspan="2"><b>Certificate of Highest Educational
                                                                    Qualification<br>उच्चतम शैक्षणिक योग्यता का प्रमाणपत्र
                                                                    अपलोड करें</b></td>
                                                            <td>
                                                                @if ($article->qualification_doc != '')
                                                                    <!-- <a href="{{ url('storage/award', $article->qualification_doc) }}"
                                                                                        target="_blank">
                                                                                        <span class="btn btn-success btn-xs">Uploaded</span>
                                                                                    </a> -->
                                                                    <a href="{{ url('storage/laxmibai_award', $article->qualification_doc) }}"
                                                                        download target="_blank">
                                                                        <!-- <span class="btn btn-success btn-xs"><i
                                                                                                class="fa fa-download"
                                                                                                aria-hidden="true"></i></span> -->
                                                            ...
                                                            <td colspan="2"><b>Domicile Certificate of UP<br>उत्तर
                                                                    प्रदेश
                                                                    का मूल निवास प्रमाण पत्र अपलोड करें</b></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td colspan="2"><b>Notary Affidavit<br> नोटरी शपथ पत्र अपलोड
                                                                    करें</b>
                                                            </td>
                                                            <td>
                                                            ...
                                                            @if ($article->highschool_certificate != '')
                                                                <td><b>Highschool/Matriculation
                                                                        Certificate<br>हाईस्कूल/मैट्रिकुलेशन प्रमाणपत्र</b>
                                                                </td>
                                                                <td>
                                                                    <a href="{{ url('storage/laxmibai_award', $article->highschool_certificate) }}"
                                                                        target="_blank">
                                                                        <!-- <span
                                                                                            class="btn btn-success btn-xs">Uploaded</span> -->
                                                                        <i class="fa fa-download"></i>
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <input class="dope_test" name="dope_test"
                                                                    ...
                                                                    {{ $article->dope_test == 1 ? 'checked' : '' }}
                                                                    value="1" required type="radio" />
                                                                &nbsp; <b>Yes/हां</b>
                                                            </td>
                                                            <td align="center">
                                                                <input class="dope_test" name="dope_test" value="2"
                                                                    {{ $article->final_submit == 1 ? 'disabled' : '' }}
                                                                    {{ $article->dope_test == 2 ? 'checked' : '' }}
                                                                    type="radio" />
                                                                &nbsp; <b>No/नहीं</b>
                                                            </td>
                                                            <td colspan="4">Have you ever been convicted for consuming
                                                                drugs during any Competition/Championship?<br>क्या आपको कभी
                                                                किसी प्रतियोगिता/चैंपियनशिप के दौरान नशीली दवाओं के सेवन के
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <input name="court_case" value="1"
                                                                    {{ $article->final_submit == 1 ? 'disabled' : '' }}
                                                                    {{ $article->court_case == 1 ? 'checked' : '' }}
                                                                    class="court_case" required type="radio" />
                                                                &nbsp; <b>Yes/हां</b>
                                                            </td>
                                                            <td align="center">
                                                                <input name="court_case" value="2"
                                                                    {{ $article->final_submit == 1 ? 'disabled' : '' }}
                                                                    {{ $article->court_case == 2 ? 'checked' : '' }}
                                                                    class="court_case" type="radio" />
                                                                &nbsp; <b>No/नहीं</b>
                                                            </td>
                                                            <td colspan="4">Have you ever been convicted by a Court of
                                                                Law in any Case/Sexual Harassment?<br>क्या आपको कभी किसी
                                                                न्यायालय द्वारा किसी मामले/यौन उत्पीड़न में दोषी ठहराया गया
                                                                है?
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="5">I hereby declare that I have read all terms
                                                                & conditions, eligibility criteria and other relevant
                                                                information related to the Application and abide by them. I
                                                                also declare that all the above particulars are true to the
                                                                best of my knowledge. If any of my facts are found to be
                                                                wrong or incorrect, my application shall be liable for
                                                                rejection and I shall be solely held responsible for
                                                                it.<br>मैं एतद्द्वारा घोषणा करता/करती हूं कि मैंने आवेदन से
                                                                संबंधित सभी नियम और शर्तें, पात्रता मानदंड और अन्य प्रासंगिक
                                                                जानकारी पढ़ ली हैं एवं उनका पालन करता/करती हूं। मैं यह भी
                                                                घोषणा करता/करती हूं कि उपरोक्त सभी विवरण मेरे अनुसार सत्य व
                                                                सही हैं। यदि मेरा कोई भी तथ्य गलत अथवा असत्य पाया जाता है,
                                                                तो मेरा आवेदन अस्वीकृत किया जा सकता है और इसके लिए पूर्णतः
                                                                मैं स्वयं उत्तरदायी ठहराया जाऊंगा/जाऊंगी।
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    if ($article->form_status == 1 || $article->form_status == 2 || $query_s != 0) { ?>
                                                            ...
                                                            @elseif($article->form_status == 2)
                                                                <td colspan="6" align="center">
                                                                    <b>Form Status :-</b> <span
                                                                        class="btn btn-danger btn-sm ml-5">Rejected</span>
                                                                </td>
                                                            @else
                                                                ...
                                                                <td colspan="3" class="noprint {{$d_check}}" align="center">
                                                                    <b>Action:- </b> &nbsp;
                                                            ...
                                                            <td colspan="3" class="noprint {{$d_check}}" align="center">
                                                                ...
                                                                @if (Auth::guard('admin')->user()->admin_role != 1 && Auth::guard('admin')->user()->admin_role != 18)
                                                                    <a href="#"
                                                                        class="btn btn-info btn-sm @if ($query_s == 1) disabled @endif"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#query_form_marked">Mark Query</a>
                                                                @endif
                                                                @if (Auth::guard('admin')->user()->admin_role != 1 && Auth::guard('admin')->user()->admin_role != 18)
                                                                    <?php $da = 'disabled';
                                                                    if (isset($article->is_forwarded_by_association) && $article->is_forwarded_by_association == 1) {
                                                    ...
                                                    <div class="accordion" id="accordionChat">
                                                        <div class="accordion-item">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <ul class="chat-list">
                                                                            ...
                                                                            @else
                                                                                <div class="text-danger"> Not Uploaded
                                                                                </div>
                                                                            @endif
                                                                        </ul>
                                                                    </div>
                                                            ...
                                                            <?php
                                                            $sss = 0;
                                                            if (Auth::guard('admin')->user()->admin_role == 3 && $article->is_forwarded_by_association > 2) {
                                                                $sss = 1;
                                                            }
                                                                    ...
                                                                    @if ($tt->type != 2)
                                                                        <div class="row mb-3">
                                                                            <div class="col-md-12 text-end">
                                                                                <a class="btn btn-primary btn-xs rplbtn reply"
                                                                                    onclick="set_reply_data({{ $tt->sender_id }},{{ $tt->reciever_id }})"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#query_form_admin""><span
                                                                                        class=" fa fa-reply fa-1x"></span>
                                                                                    Reply </a>
                                                                            </div>
                                                                        </div>
                                                                    @else
                                                                        <div class="row mb-3">
                                                                            <div class="col-md-12 text-end">
                                                                                <a class="btn btn-primary btn-xs rplbtn reply"
                                                                                    onclick="set_reply_data({{ $tt->sender_id }},{{ $tt->reciever_id }})"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#reply_of_query"><span
                                                                                        class="fa fa-reply fa-1x"></span>
                                                                                    Reply
                                                                                </a>
                                                                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <h5>Your Registration is completed and Password has been sent on your registered Mobile No. & Email ID.
                    Kindly Login to proceed.</h5>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="file" required name="query_doc_by_admin"
                                class="form-control remove_danger" onchange="getfileext(this.value,10)"
                                id="File10" aria-describedby="inputGroupFileAddon05" aria-label="Upload">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
