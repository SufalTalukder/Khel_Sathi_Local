...
<div class="row">
	<div class="col-md-12">
		<div class="pageheader" id="menu-margin">
			<h4 class="mb-0">List of Rani Laxmi Bai Applicant
				<!-- <a class="btn btn-sm btn-success" href="{{ route('exportExcel',2) }}"> -->
				<a class="btn btn-sm btn-success float-end" id="exportExcel">
					<i class="fa fa-file-excel"></i> Export to Excel
				</a>
				<!-- <a class="btn btn-sm btn-danger" href="{{ route('exportPdf',2) }}"> -->
		...
		<div class="card">
			<div class="card-body">
				<form class="row">
					<div class="col-md-2">
						<input type="hidden" value="2" id="form_type">
