                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab">
                    <div class="bhoechie-tab-content active">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12" id="prodiv">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2" align="center"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                style="font-size: 18px; font-weight: bold;">
                                                                                Nomination Form to Seek Reward from
                                                                                Government of UP / उ0प्र0 सरकार से पुरस्कार
                                                                                प्राप्त करने हेतु नामांकन प्रपत्र</div>
                                                                            <div
                                                                                style="font-size: 18px; font-weight: bold;">
                                                                                वित्तीय वर्ष 2025-26 में लक्ष्मण पुरस्कार
                                                            ...
                                                            @foreach ($articles as $article)
                                                                ...
                                                                <div class="d-flex justify-content-between bg-light p-2">
                                                                    <div>
                                                                        Is Applicant Physically Challenged ? / क्या आवेदक
                                                                        शारीरिक रूप से अक्षम है?-
                                                                ...
                                                                <table id="dataTable" class="table table-bordered"
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 20%;"><b>Applicant's Full
                                                                                Name<br>आवेदक का पूरा नाम</b>
                                                                        </td>
                                                                        <td>{{ $article->fullname }}</td>
                                                                        <td><b>Which Sport did/do you play?<br>कौन सा खेल
                                                                                खेलते थे/हैं?</b>
                                                                        </td>
                                                                        <td>{{ $article->sport_name }}</td>
                                                                        <td colspan="2" rowspan="5"
                                                                            style="width: 20%;"><b>Photograph of
                                                                                Applicant's<br>आवेदक की फोटो</b><br />
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4" class="bg-light">
                                                                            <strong>Applicant's Details/आवेदक का
                                                                                विवरण</strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ districtName($article->place_of_birth) }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Highest Educational Qualification<br>उच्चतम
                                                                                शैक्षणिक योग्यता</b>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td><b>Flat No. / House No.<br>फ्लैट संख्या / मकान
                                                                                संख्या</b>
                                                                        </td>
                                                                        ...
                                                                        <td>{{ districtName($article->present_district) }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ districtName($article->permanent_district) }}
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2"><b>Mobile No. (registered with
                                                                                Bank Account)<br>मोबाइल नंबर (बैंक खाते के
                                                                                साथ जो पंजीकृत है)</b>
                                                                        </td>
                                                                        <td>{{ $article->mobile_registered_in_bank }}</td>
                                                                        <td colspan="2"><b>Any other relevant information
                                                                                applicant wants to specify?<br>कोई अन्य
                                                                                प्रासंगिक जानकारी आवेदक निर्दिष्ट करना चाहते
                                                                                हैं?</b>
                                                                        </td>
                                                                        <td>{{ $article->other_relevant_information_applicant }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="6">
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="6" class="bg-light">
                                                                            <strong>Other Achievements/अन्य
                                                                                उपलब्धियां</strong>
                                                                        </td>
                                                                    </tr>
                                                                    @foreach ($other_achievement as $item)
                                                                        <tr>
                                                                            <td><b>Name of the Achievement<br>उपलब्धि का
                                                                                    नाम</b>
                                                                            </td>
                      ...
                      <span class="btn btn-success btn-xs">Uploaded</span>
                                                                                    ...
                                                                                    <a href="{{ url('storage/laxman_award', $item->achievement_docs) }}"
                                                                                        download target="_blank">
                                                                                        <!-- <span class="btn btn-success btn-xs"><i class="fa fa-download" aria-hidden="true"></i></span> -->
                                                                                        <i class="fa fa-download"></i>
                                                                                    </a>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2"><b>Certificate of Highest
                                                                                Educational Qualification<br>उच्चतम शैक्षणिक
                                                                                योग्यता का प्रमाणपत्र अपलोड करें</b></td>
                                                                        <td>
                      ...
                      <span class="btn btn-success btn-xs">Uploaded</span>
                                                                        ...
                                                                        <td colspan="2"><b>Domicile Certificate of
                                                                                UP<br>उत्तर प्रदेश का मूल निवास प्रमाण पत्र
                                                                                अपलोड करें</b></td>
                                                                        <td>
                      ...
                      <span class="btn btn-success btn-xs">Uploaded</span>
                                                                                ...
                                                                                <a href="{{ url('storage/laxman_award', $article->domicile_certificate) }}"
                                                                                    download target="_blank">
                                                                                    <!-- <span class="btn btn-success btn-xs"><i class="fa fa-download" aria-hidden="true"></i></span> -->
                                                                                    <i class="fa fa-download"></i>
                                                                                </a>
																	...
																	<tr>
																		<td colspan="2"><b>Notary Affidavit<br> नोटरी शपथ पत्र अपलोड करें</b>
																		</td>
																		<td>
                                                                        ...
                                                                        @if ($article->highschool_certificate != '')
                                                                            <td colspan="2"><b>Highschool/Matriculation
                                                                                    Certificate<br>हाईस्कूल/मैट्रिकुलेशन
                                                                                    प्रमाणपत्र</b>
                                                                            </td>
                                                                            <td>
                                                                                <a href="{{ url('storage/laxman_award', $article->highschool_certificate) }}"
                                                                                    target="_blank">
                                                                                    <!-- <span class="btn btn-success btn-xs">Uploaded</span> -->
                                                                                    <i class="fa fa-download"></i>
                                                                                </a>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="4">Have you ever been convicted for
                                                                            consuming drugs during any
                                                                            Competition/Championship?<br>क्या आपको कभी किसी
                                                                            प्रतियोगिता/चैंपियनशिप के दौरान नशीली दवाओं के
                                                                            सेवन के लिए दोषी ठहराया गया है?</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="6" class="bg-light">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="4">Have you ever been convicted by
                                                                            a Court of Law in any Case/Sexual
                                                                            Harassment?<br>क्या आपको कभी किसी न्यायालय
                                                                            द्वारा किसी मामले/यौन उत्पीड़न में दोषी ठहराया
                                                                            गया है?</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="6" class="bg-light">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="5">I hereby declare that I have
                                                                            read all terms & conditions, eligibility
                                                                            criteria and other relevant information related
                                                                            to the Application and abide by them. I also
                                                                            declare that all the above particulars are true
                                                                            to the best of my knowledge. If any of my facts
                                                                            are found to be wrong or incorrect, my
                                                                            application shall be liable for rejection and I
                                                                            shall be solely held responsible for it.<br>मैं
                                                                            एतद्द्वारा घोषणा करता/करती हूं कि मैंने आवेदन से
                                                                            संबंधित सभी नियम और शर्तें, पात्रता मानदंड और
                                                                            अन्य प्रासंगिक जानकारी पढ़ ली हैं एवं उनका पालन
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3" align="center">
                                                                            ...
                                                                            <b>Applicant's Signature<br>आवेदक के
                                                                                हस्ताक्षर</b>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
																...
																if ($article->form_status == 1 || $article->form_status == 2 || $query_s != 0) { ?>
                                                                        ...
                                                                        @else
                                                                            ...
                                                                            <td colspan="3" class="noprint {{$d_check}}"
                                                                                align="center">
                                                                                <b>Action:- </b> &nbsp;
