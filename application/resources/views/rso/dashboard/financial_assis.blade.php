...
<div class="row">
    <div class="col-md-12">
        <div class="pageheader" id="menu-margin">
            <h4 class="mb-0">List of Financial Assistance Applicant <!-- <a class="btn btn-sm btn-success" href="{{ route('exportExcel',4) }}"> -->
        ...
        <div class="card">
            <div class="card-body">
                <form class="row">
                    <div class="col-md-3">
                        <input type="hidden" value="4" id="form_type">
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-select" id="status_filter" name="status_filter" onchange="handeChange(this)">
                            <option {{$seg=='all' ? 'selected' : ""}} value="all">--All--</option>
