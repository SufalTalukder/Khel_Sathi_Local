...
<!-- <div class="pagebody removebg-color row"> -->
                    <div class="pageheader">
                        <div class="row">
                            <!-- <div class="col-md-10">
                                <h4 class="mb-0"> Dashboard / Applications Received to Seek Financial Assistance</h4>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                    <a class="btn btn-sm btn-success" href="{{ route('exportExcel',4) }}">
                                        <i class="fa fa-file-excel"></i>
                                    </a>
                                    <a class="btn btn-sm btn-danger" href="{{ route('exportPdf',4) }}">
                                 ...
                                 <div class="table-responsive" style="max-height: 350px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php $abc=marked_status( $list->user_id,4);?>
                                            <td>
                                            ...
                                            @endif
                                            @else
                                            <strong class="btn btn-danger btn-xs disabled btn-block">Not Marked</strong>
                                            @endif
                                            </td>

                                            <td class="text-center">
                                                <a class="btn btn-sm btn-dark" href="{{ route('financial_assis_view',$list->user_id) }}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <div style="display: inline-block;">
                                                <?php if($list->form_status == 3) { ?>
                                                <strong class="btn btn-danger btn-xs disabled btn-block">Not Forwarded</strong>
                                            ...
                                            <td><?php if($list->is_forwarded_by_rso == 1) { ?>
        ...
        <div class="modal fade" id="forwardedbtn1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <!--<button type="button" class="btn btn btn-outline-danger"><span class="icons icon-cloud-download"></span> Download</button>-->
                        <form action="{{route('financial_forward')}}" method="post" >
                            @csrf
