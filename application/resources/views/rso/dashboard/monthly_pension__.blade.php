...
<!-- <div class="pagebody removebg-color row"> -->
                    <div class="pageheader">
                        <div class="row">
                            <!-- <div class="col-md-10">
                                <h4 class="mb-0"> Dashboard / Applications Received to Seek Monthly Pension</h4>
                            </div>
                                 ...
                                 <div class="table-responsive" style="max-height: 350px;">
                                  ...
                                  <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php $abc=marked_status( $list->user_id,5);?>
                                            <td>
                                            ...
                                            <td class="text-center"><a class="btn btn-sm btn-dark" href="{{ route('monthly_pension_view',$list->user_id) }}"><i class="fa fa-eye"></i></a>
                                            
                                            <div style="display: inline-block;"><?php if($list->form_status == 3) { ?>
