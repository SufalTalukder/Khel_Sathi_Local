...
@section( 'content' )
		...
		<div class="pageheader" id="menu-margin">
			<h4 class="mb-0"> Final Approved <!-- <a class="btn btn-sm btn-success" href="{{ route('exportExcel',5) }}"> -->
                <a title="Sport Wise Count" class="btn btn-sm btn-success float-end" onclick="ExportToExcel('xlsx')">
                    <i class="fa fa-file-excel"></i> Export to Excel
                  </a>
				<a title="Application Details ExportToExcel" class="btn btn-sm btn-success float-end" href="{{route('download_hostel_pdftest',2)}}">
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="mb-4">
					<form class="row" method="post" action="{{ route('hostel_final_approved_list') }}">
                        @csrf
						<div class="col-md-1">
                        ...
                        <div class="col-md-1">
							<label for="reset">&nbsp;</label>
							<a href="{{ route('hostel_final_approved_list') }}" class="btn btn-success  btn-block">
					      	Reset
                            </a>
						</div>
                        <div class="col-md-1">
...
$.ajax({
        type: "POST",
data:{arr},
        url: ajaxUrl + '/hosteladmin/final_approved_list_store',
        dataType: "json",
