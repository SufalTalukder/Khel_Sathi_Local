...
@section( 'content' )
		...
		<div class="pageheader" id="menu-margin">
			<h4 class="mb-0"> List of Hostel Applicant<!-- <a class="btn btn-sm btn-success" href="{{ route('exportExcel',5) }}"> -->
				...
				<a title="Application Details ExportToExcel" class="btn btn-sm btn-success float-end" href="{{route('download_hostel_pdf',3)}}">
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="mb-4">
					<form class="row" method="post" action="{{ route('division_level_approved') }}">
                        @csrf
						<div class="col-md-1">
                        ...
                        <div class="col-md-1">
							<label for="reset">&nbsp;</label>
							<a href="{{ route('division_level_approved') }}" class="btn btn-success  btn-block">
					      	Reset
                            </a>
						</div>
                        <div class="col-md-1">
						...
						<tbody id="hostelapplicant">
							...
							<tr>
								...
								<td><a class="btn btn-sm btn-dark" href="{{route('hostelView', $item->id)}}"><i class="fa fa-eye"></i>   </a> </td>
                                 <td>
                                    @if ($item->division_level_approved)
