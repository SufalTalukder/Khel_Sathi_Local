...
<div class="row">
	<div class="col-md-12">
		...
		<div class="card">
			...
			<div class="card-body">
				<form action="{{route('hosteladmintrialListfourtest')}}" method="post">
					@csrf
					<div class="row">
...
{{-- change on basis of subSport and gender --}}
	...
	@elseif ($trialType == 2)
		            ...
		            @elseif ($trialType == 3)
							...
							<td><input type="number"  class="stop-{{$applicant->id}}" name="service" @if(isset($trialvolleyball) && $trialvolleyball->service != '') readonly @endif value="@if(isset($trialvolleyball)){{$trialvolleyball->service}}@endif"  id="service{{$applicant->id}}"  oninput="volleyballskillTotal({{$applicant->id}})"  style="
							width: 50px;
							font-weight: 400;
							background: none;
							border: 1px solid #cdcdcd;
        ...
        ">
					...
					<td>
						...
						<input type="hidden" name="sport_id" value="{{ data_get($filterData, 'sport_id') }}">
                        <input type="hidden" name="trial_type" value="4">
						<input type="number"  class="stop-{{$applicant->id}}" name="stance_mark"  @if(isset($trialathleticsthrower) && $trialathleticsthrower->throwing_stance_mark != '') readonly @endif  value="@if(isset($trialathleticsthrower)){{$trialathleticsthrower->throwing_stance_mark}}@endif"  oninput="athleticsthrowerskillTotal({{$applicant->id}})" id="stance_mark{{$applicant->id}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 1px solid #cdcdcd;
					...
					<td><input type="number"  class="stop-{{$applicant->id}}"  name="service_mark" @if(isset($trialtabletennis) && $trialtabletennis->service_mark != '') readonly @endif value="@if(isset($trialtabletennis)){{$trialtabletennis->service_mark}}@endif" id="service_mark{{$applicant->id}}"  oninput="tabletennisskillTotal({{$applicant->id}})" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 1px solid #cdcdcd;
