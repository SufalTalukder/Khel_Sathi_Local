...
<div class="col-md-6 bg-light1">
                <div class="p-4 p-lg-5 login-form">
                    <div class="text-center text-md-center mb-4 mt-md-0">
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-2"><span class="fw-normal">Don't have an account? <a href="{{route('gymnasium_swimmingregistration')}}" class="fw-bold">Register Here </a>
अकाउंट नहीं है? <a href="{{route('gymnasium_swimmingregistration')}}" class="fw-bold">अभी पंजीकरण करें</a></span></div>
                    </div>
                    <form action="{{route('gymnasium_swimming_loginStore')}}" id="gymsubmit" class="mt-4 needs-validation" novalidate method="post">
            @csrf
                 ...
                 @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex justify-content-between align-items-top">
                            <a href="{{ route('gymnasium_swimming_forgotpassword') }}" class="small text-right"><b>Forgot Password?/पासवर्ड भूल गए?</b></a>
