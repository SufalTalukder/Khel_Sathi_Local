...
<div class="col-md-6 bg-light1">
                ...
                <div class="p-4 p-lg-5 login-form">
                    ...
                    <form action="{{ route('eklavya_kreeda_kosh_forgotStore') }}" class="mt-4 needs-validation" novalidate method="post">
                    @csrf
                        ...
                        <div><a href="{{ route('eklavya_kreeda_kosh_login') }}" class="small btn btn-outline-light rounded-pill">Back to Login/पिछले चरण पर जाएं</a>
