...
<div class="row">
  <div class="col-md-12">
    <div class="pageheader" id="menu-margin">
      <h4 class="mb-0">
        ...
        {{-- change on basis of subSport and gender --}}
         ...
         <a href="#" onclick="ExportToExcel('xlsx')" class="btn btn-success btn-sm float-end m-0 mx-2"><i class="fa fa-file-excel-o"></i> Export To Excel</a>
    ...
    <div class="card">
      <div class="card-body">
        <form action="{{route('collegeadminfiltertrialList')}}" method="post">
          @csrf
          <div class="row">
            ...
            <div class="mb-3 col-md-2">
              ...
              <div class="mb-3 col-md-2">
                  <div class="form-group">
                    ...
                    <select class="form-select" name="trial_result" style="width: 100%;" onchange="trial_resultt(this.value)">
                      <option value="">Select </option>

                      <option value="1" {{request()->input('trial_result') == 1 ? 'selected' : ''}} >Pending</option>
                      <option value="2" {{request()->input('trial_result') == 2 ? 'selected' : ''}} >Pass</option>
                      <option value="4" {{request()->input('trial_result') == 4 ? 'selected' : ''}}  >Fail</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="mb-3 col-md-2" id="gender_result">
                    <div class="form-group">
                      <label>Gender For Result</label>
...
">)&nbsp;&nbsp;&nbsp;&nbsp; Category - Boys
        ...
        <div class="table-responsive">
          <table id="dataTable" class="table text-center table-bordered" style="
    font-size: smaller;
">
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <tr>
                <form action="{{route('trialListApplicantStore')}}" method="POST" id="form_{{$applicant->application_no}}" class="needs-validation applicantData" novalidate>
                  ...
                  <?php $trial = trialData($applicant->application_no, $filterData['subSport'], 1); ?>
                  @if(isset($trial))
                  ...
                  <td valign="top"> {{ $applicant->trial_location }}</td>
                  <td valign="top"> {{ $applicant->admission_seeking }}</td>
                    ...
                    <input type="number" name="hundred_mt_time" id="hundtime{{$applicant->application_no}}" @if(isset($trial)) readonly @endif value="@if(isset($trial)){{($trial->hundred_mt_time)}}@endif"  oninput="hundred_mt_score({{$applicant->application_no}},{{$applicant->gender}},{{get_age($applicant->dob, '2025-04-01')}})" required style="
			width: 50px;
			font-weight: 400;
			background: none;
		...
		">
                  ...
                  <td><input type="number" name="hundred_mt_mark" max="10"  id="hund{{$applicant->application_no}}"  oninput="allAdd({{$applicant->application_no}})" required @if(isset($trial))  @endif readonly value="@if(isset($trial)){{($trial->hundred_mt_mark)}}@endif" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 1px solid #cdcdcd;
		"></td>
                  <td class="d-flex"><input type="number" name="eight_hundred_mt_time" id="eighttime{{$applicant->application_no}}" required @if(isset($trial)) readonly @endif value="@if(isset($trial)){{($trial->eight_hundred_mt_time)}}@endif"  onblur="eight_mt_score({{$applicant->application_no}},{{$applicant->gender}},{{get_age($applicant->dob, '2025-04-01')}})" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 1px solid #cdcdcd;
		...
		"></td>
			...
			border: 1px solid #cdcdcd;
		"></td>
                  <td><input type="number" readonly name="physical_total_mark" max="50" id="phy{{$applicant->application_no}}" required @if(isset($trial)) readonly @endif value="@if(isset($trial)){{($trial->physical_total_mark)}}@endif" style="
			width: 50px;
			font-weight: 400;
			background: none;
		...
		"></td>
                ...
                <form action="{{route('collegeadminhockeytrialList')}}" id="hockey_{{$applicant->application_no}}" class="needs-validation hockeyData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialhockey = trialhockeyData($applicant->application_no, 1); ?>
                  ...
                  <td><input type="number" name="game_technique" @if(isset($trialhockey)) readonly value="{{$trialhockey->game_technique}}" @endif oninput="mainTotal({{$applicant->application_no}})" id="game_technique{{$applicant->application_no}}" style="
						...
						border: 1px solid #cdcdcd;
						"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialhockey)) readonly value="{{$trialhockey->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
						width: 50px;
						font-weight: 400;
						background: none;
						border: 2px solid #868686;
						"></td>
                  <td><input type="number" name="total_obtain_mark" readonly  @if(isset($trialhockey)) readonly value="{{$trialhockey->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
							width: 50px;
							font-weight: 400;
							background: none;
							border: 2px solid #868686;
                  ...
                  <td><input type="text" name="remark" @if(isset($trialhockey)) readonly value="{{$trialhockey->remark}}" @endif id="remark{{$applicant->application_no}}" style="
						...
						border: 1px solid #cdcdcd;
						"></td>
                  <td><input type="checkbox" id="checkhockey{{$applicant->application_no}}" @if(isset($trialhockey)) checked disabled @endif onChange="hockeyData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          border: 1px solid #cdcdcd;
          ...
          <td> @if(isset($trialhockey)) {{dmy($trialhockey->date)}} @endif</td>
                ...
                <form action="{{route('collegeadminhockeykeepertrialList')}}" id="hockeykeeper_{{$applicant->application_no}}" class="needs-validation hockeykeeperData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialhockeykeeper = trialhockeykeeperData($applicant->application_no, 1); ?>
                  ...
                  <td><input type="number" name="game_technique" @if(isset($trialhockeykeeper)) readonly value="{{$trialhockeykeeper->game_technique}}" @endif oninput="mainTotal({{$applicant->application_no}})" id="game_technique{{$applicant->application_no}}" style="
					...
					border: 1px solid #cdcdcd;
					"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialhockeykeeper)) readonly value="{{$trialhockeykeeper->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 2px solid #868686;
					"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialhockeykeeper)) readonly value="{{$trialhockeykeeper->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 2px solid #868686;
                  ...
                  <td><input type="text" name="remark" @if(isset($trialhockeykeeper)) readonly value="{{$trialhockeykeeper->remark}}" @endif id="remark{{$applicant->application_no}}" style="
					...
					border: 1px solid #cdcdcd;
					"></td>
                  <td><input type="checkbox" id="checkhockeykeeper{{$applicant->application_no}}" @if(isset($trialhockeykeeper)) checked disabled @endif onChange="hockeykeeperData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialhockeykeeper)) {{dmy($trialhockeykeeper->date)}} @endif</td>
                ...
                <form action="{{route('collegeadminbadmintontrialList')}}" id="badmin_{{$applicant->application_no}}" class="needs-validation badminData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialbadminton = trialBadmintonData($applicant->application_no, 1); ?>
                  ...
                  <td><input type="number" name="game_technique" @if(isset($trialbadminton)) readonly value="{{$trialbadminton->game_technique}}" @endif oninput="mainTotal({{$applicant->application_no}})" id="game_technique{{$applicant->application_no}}" style="
							...
							border: 1px solid #cdcdcd;
							"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialbadminton)) readonly value="{{$trialbadminton->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
							width: 50px;
							font-weight: 400;
							background: none;
							border: 2px solid #868686;
							"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialbadminton)) readonly value="{{$trialbadminton->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
							width: 50px;
							font-weight: 400;
							background: none;
							border: 2px solid #868686;
                  ...
                  <td><input type="text" name="remark" @if(isset($trialbadminton)) readonly value="{{$trialbadminton->remark}}" @endif id="remark{{$applicant->application_no}}" style="
							...
							border: 1px solid #cdcdcd;
							"></td>
                  <td><input type="checkbox" id="checkbad{{$applicant->application_no}}" @if(isset($trialbadminton)) checked disabled @endif onChange="badminData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialbadminton)) {{dmy($trialbadminton->date)}} @endif</td>
                ...
                <form action="{{route('collegeadminvolleyBalltrialList')}}" id="volleyball_{{$applicant->application_no}}" class="needs-validation volleyballData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialvolleyball = trialvolleyballData($applicant->application_no, 1); ?>
                  ...
                  <td><input type="number" name="game_technique" @if(isset($trialvolleyball)) readonly value="{{$trialvolleyball->game_technique}}" @endif oninput="mainTotal({{$applicant->application_no}})" id="game_technique{{$applicant->application_no}}" style="
							...
							border: 1px solid #cdcdcd;
							"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialvolleyball)) readonly value="{{$trialvolleyball->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
							width: 50px;
							font-weight: 400;
							background: none;
							border: 2px solid #868686;
							"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialvolleyball)) readonly value="{{$trialvolleyball->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
							width: 50px;
							font-weight: 400;
							background: none;
							border: 2px solid #868686;
                  ...
                  <td><input type="text" name="remark" @if(isset($trialvolleyball)) readonly value="{{$trialvolleyball->remark}}" @endif id="remark{{$applicant->application_no}}" style="
							...
							border: 1px solid #cdcdcd;
							"></td>
                  <td><input type="checkbox" id="checkvolleyball{{$applicant->application_no}}" @if(isset($trialvolleyball)) checked disabled @endif onChange="volleyballData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialvolleyball)) {{dmy($trialvolleyball->date)}} @endif</td>
                ...
                <form action="{{route('collegeadminkustitrialList')}}" id="kusti_{{$applicant->application_no}}" class="needs-validation kustiData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialkusti = trialkustiData($applicant->application_no, 1); ?>
                  @if(isset($trialkusti))
			...
			">
                  ...
                  <td><input type="number" name="front_position_back_position_mark" @if(isset($trialkusti)) readonly value="{{$trialkusti->front_position_back_position_mark}}" @endif id="front_position_back_position_mark{{$applicant->application_no}}" oninput="kustiskillTotal({{$applicant->application_no}})" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="number" name="test_score_mark" readonly @if(isset($trialkusti))value="{{$trialkusti->test_score_mark}}" @endif id="test_score_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialkusti)) readonly value="{{$trialkusti->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialkusti)) readonly value="{{$trialkusti->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="checkbox" id="checkkusti{{$applicant->application_no}}" @if(isset($trialkusti)) checked disabled @endif onChange="kustiData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialkusti)) {{dmy($trialkusti->date)}} @endif</td>
                ...
                <form action="{{route('collegeadminswimmingtrialList')}}" id="swimming_{{$applicant->application_no}}" class="needs-validation swimmingData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialswimming = trialswimmingData($applicant->application_no, 1); ?>
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialswimming)) readonly value="{{$trialswimming->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialswimming)) readonly value="{{$trialswimming->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="checkbox" id="checkswimming{{$applicant->application_no}}" @if(isset($trialswimming)) checked disabled @endif onChange="swimmingData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialswimming)) {{dmy($trialswimming->date)}} @endif</td>
                ...
                <form action="{{route('collegeadminfootballkeepertrialList')}}" id="footballkeeper_{{$applicant->application_no}}" class="needs-validation footballkeeperData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialfootballkeeper = trialfootballkeeperData($applicant->application_no, 1); ?>
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialfootballkeeper)) readonly value="{{$trialfootballkeeper->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialfootballkeeper)) readonly value="{{$trialfootballkeeper->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="checkbox" id="checkfootballkeeper{{$applicant->application_no}}" @if(isset($trialfootballkeeper)) checked disabled @endif onChange="footballkeeperData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialfootballkeeper)) {{dmy($trialfootballkeeper->date)}} @endif</td>
                ...
                <form action="{{route('collegeadminfootballtrialList')}}" id="football_{{$applicant->application_no}}" class="needs-validation footballData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialfootball = trialfootballData($applicant->application_no, 1); ?>
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialfootball)) readonly value="{{$trialfootball->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialfootball)) readonly value="{{$trialfootball->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="checkbox" id="checkfootball{{$applicant->application_no}}" @if(isset($trialfootball)) checked disabled @endif onChange="footballData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialfootball)) {{dmy($trialfootball->date)}} @endif</td>
                ...
                <form action="{{route('collegeadminathleticsjumpertrialList')}}" id="athleticsjumper_{{$applicant->application_no}}" class="needs-validation athleticsjumperData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialathleticsjumper = trialathleticsjumperData($applicant->application_no, 1); ?>
                  ...
                  <td><input type="number" name="game_technique" @if(isset($trialathleticsjumper)) readonly value="{{$trialathleticsjumper->game_technique}}" @endif oninput="mainTotal({{$applicant->application_no}})" id="game_technique{{$applicant->application_no}}" style="
					...
					border: 1px solid #cdcdcd;
					"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialathleticsjumper)) readonly value="{{$trialathleticsjumper->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 2px solid #868686;
					"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialathleticsjumper)) readonly value="{{$trialathleticsjumper->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 2px solid #868686;
                  ...
                  <td><input type="text" name="remark" @if(isset($trialathleticsjumper)) readonly value="{{$trialathleticsjumper->remark}}" @endif id="remark{{$applicant->application_no}}" style="
					...
					border: 1px solid #cdcdcd;
					"></td>
                  <td><input type="checkbox" id="checkathleticsjumper{{$applicant->application_no}}" @if(isset($trialathleticsjumper)) checked disabled @endif onChange="athleticsjumperData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialathleticsjumper)) {{dmy($trialathleticsjumper->date)}} @endif</td>
                ...
                <form action="{{route('collegeadmincricketbatsmantrialList')}}" id="cricketbatsman_{{$applicant->application_no}}" class="needs-validation cricketbatsmanData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialcricketbatsman = trialcricketbatsmanData($applicant->application_no, 1); ?>
				...
				border: 1px solid #cdcdcd;
				"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialcricketbatsman)) readonly value="{{$trialcricketbatsman->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
				width: 50px;
				font-weight: 400;
				background: none;
				border: 2px solid #868686;
				"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialcricketbatsman)) readonly value="{{$trialcricketbatsman->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
				width: 50px;
				font-weight: 400;
				background: none;
				border: 2px solid #868686;
				...
				border: 1px solid #cdcdcd;
				"></td>
                  <td><input type="checkbox" id="checkcricketbatsman{{$applicant->application_no}}" @if(isset($trialcricketbatsman)) checked disabled @endif onChange="cricketbatsmanData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          "> </td>
           ...
           <td> @if(isset($trialcricketbatsman)) {{dmy($trialcricketbatsman->date)}} @endif</td>
                ...
                <form action="{{route('collegeadmincricketballertrialList')}}" id="cricketballer_{{$applicant->application_no}}" class="needs-validation cricketballerData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialcricketballer = trialcricketballerData($applicant->application_no, 1); ?>
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialcricketballer)) readonly value="{{$trialcricketballer->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialcricketballer)) readonly value="{{$trialcricketballer->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="checkbox" id="checkcricketballer{{$applicant->application_no}}" @if(isset($trialcricketballer)) checked disabled @endif onChange="cricketballerData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialcricketballer)) {{dmy($trialcricketballer->date)}} @endif</td>
                ...
                <form action="{{route('collegeadmincricketkeepertrialList')}}" id="cricketkeeper_{{$applicant->application_no}}" class="needs-validation cricketkeeperData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialcricketkeeper = trialcricketkeeperData($applicant->application_no, 1); ?>
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialcricketkeeper)) readonly value="{{$trialcricketkeeper->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialcricketkeeper)) readonly value="{{$trialcricketkeeper->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="checkbox" id="checkcricketkeeper{{$applicant->application_no}}" @if(isset($trialcricketkeeper)) checked disabled @endif onChange="cricketkeeperData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialcricketkeeper)) {{dmy($trialcricketkeeper->date)}} @endif</td>
                ...
                <form action="{{route('collegeadminkabadditrialList')}}" id="kabaddi_{{$applicant->application_no}}" class="needs-validation kabaddiData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialkabaddi = trialkabaddiData($applicant->application_no, 1); ?>
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialkabaddi)) readonly value="{{$trialkabaddi->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialkabaddi)) readonly value="{{$trialkabaddi->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
			width: 50px;
			font-weight: 400;
			background: none;
			border: 2px solid #868686;
			...
			border: 1px solid #cdcdcd;
			"></td>
                  <td><input type="checkbox" id="checkkabaddi{{$applicant->application_no}}" @if(isset($trialkabaddi)) checked disabled @endif onChange="kabaddiData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialkabaddi)) {{dmy($trialkabaddi->date)}} @endif</td>
                ...
                <form action="{{route('collegeadminjudotrialList')}}" id="judo_{{$applicant->application_no}}" class="needs-validation judoData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialjudo = trialjudoData($applicant->application_no, 1); ?>
                  @if(isset($trialjudo))
        ...
        border: 1px solid #cdcdcd;
        "></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialjudo)) readonly value="{{$trialjudo->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
        width: 50px;
        font-weight: 400;
        background: none;
        border: 2px solid #868686;
        "></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialjudo)) readonly value="{{$trialjudo->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
        width: 50px;
        font-weight: 400;
        background: none;
        border: 2px solid #868686;
        ...
        border: 1px solid #cdcdcd;
        "></td>
                  <td><input type="checkbox" id="checkjudo{{$applicant->application_no}}" @if(isset($trialjudo)) checked disabled @endif onChange="judoData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialjudo)) {{dmy($trialjudo->date)}} @endif</td>
                ...
                <form action="{{route('collegeadminathleticsrunnertrialList')}}" id="athleticsrunner_{{$applicant->application_no}}" class="needs-validation athleticsrunnerData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialathleticsrunner = trialathleticsrunnerData($applicant->application_no, 1); ?>
                  ...
                  <td><input type="number" name="game_technique" @if(isset($trialathleticsrunner)) readonly value="{{$trialathleticsrunner->game_technique}}" @endif oninput="mainTotal({{$applicant->application_no}})" id="game_technique{{$applicant->application_no}}" style="
					...
					border: 1px solid #cdcdcd;
					"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialathleticsrunner)) readonly value="{{$trialathleticsrunner->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 2px solid #868686;
					"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialathleticsrunner)) readonly value="{{$trialathleticsrunner->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 2px solid #868686;
                  ...
                  <td><input type="text" name="remark" @if(isset($trialathleticsrunner)) readonly value="{{$trialathleticsrunner->remark}}" @endif id="remark{{$applicant->application_no}}" style="
					...
					border: 1px solid #cdcdcd;
					"></td>
                  <td><input type="checkbox" id="checkathleticsrunner{{$applicant->application_no}}" @if(isset($trialathleticsrunner)) checked disabled @endif onChange="athleticsrunnerData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialathleticsrunner)) {{dmy($trialathleticsrunner->date)}} @endif</td>
                ...
                <form action="{{route('collegeadmingymnasticboystrialList')}}" id="gymnasticboys_{{$applicant->application_no}}" class="needs-validation gymnasticboysData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialgymnasticboys = trialgymnasticboysData($applicant->application_no, 1); ?>
                  ...
                  <td><input type="number" name="game_technique" @if(isset($trialgymnasticboys)) readonly value="{{$trialgymnasticboys->game_technique}}" @endif oninput="mainTotal({{$applicant->application_no}})" id="game_technique{{$applicant->application_no}}" style="
					...
					border: 1px solid #cdcdcd;
					"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialgymnasticboys)) readonly value="{{$trialgymnasticboys->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 2px solid #868686;
					"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialgymnasticboys)) readonly value="{{$trialgymnasticboys->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 2px solid #868686;
                  ...
                  <td><input type="text" name="remark" @if(isset($trialgymnasticboys)) readonly value="{{$trialgymnasticboys->remark}}" @endif id="remark{{$applicant->application_no}}" style="
					...
					border: 1px solid #cdcdcd;
					"></td>
                  <td><input type="checkbox" id="checkgymnasticboys{{$applicant->application_no}}" @if(isset($trialgymnasticboys)) checked disabled @endif onChange="gymnasticboysData({{$applicant->application_no}})" {{$applicant->application_no}} style="width: 50px; font-weight: 400; background: none; border: 1px solid #cdcdcd;"> </td>
                ...
                <form action="{{route('collegeadmingymnasticgirlstrialList')}}" id="gymnasticgirls_{{$applicant->application_no}}" class="needs-validation gymnasticgirlsData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialgymnasticgirls = trialgymnasticgirlsData($applicant->application_no, 1); ?>
                  ...
                  <td><input type="number" name="game_technique" @if(isset($trialgymnasticgirls)) readonly value="{{$trialgymnasticgirls->game_technique}}" @endif oninput="mainTotal({{$applicant->application_no}})" id="game_technique{{$applicant->application_no}}" style="
					...
					border: 1px solid #cdcdcd;
					"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialgymnasticgirls)) readonly value="{{$trialgymnasticgirls->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 2px solid #868686; 
					"></td>
                  <td><input type="number"  name="total_obtain_mark" readonly @if(isset($trialgymnasticgirls)) readonly value="{{$trialgymnasticgirls->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 2px solid #868686;
                  ...
                  <td><input type="text" name="remark" @if(isset($trialgymnasticgirls)) readonly value="{{$trialgymnasticgirls->remark}}" @endif id="remark{{$applicant->application_no}}" style="
					...
					border: 1px solid #cdcdcd;
					"></td>
                  <td><input type="checkbox" id="checkgymnasticgirls{{$applicant->application_no}}" @if(isset($trialgymnasticgirls)) checked disabled @endif onChange="gymnasticgirlsData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <td> @if(isset($trialgymnasticgirls)) {{dmy($trialgymnasticgirls->date)}} @endif</td>
                ...
                <form action="{{route('collegeadminathleticsthrowertrialList')}}" id="athleticsthrower_{{$applicant->application_no}}" class="needs-validation athleticsthrowerData" novalidate method="post">
                  @if(isset($applicant->application_no))
                  <?php $trialathleticsthrower = trialathleticsthrowerData($applicant->application_no, 1); ?>
                  ...
                  <td><input type="number" name="game_technique" @if(isset($trialathleticsthrower)) readonly value="{{$trialathleticsthrower->game_technique}}" @endif oninput="mainTotal({{$applicant->application_no}})" id="game_technique{{$applicant->application_no}}" style="
					...
					border: 1px solid #cdcdcd;
					"></td>
                  <td><input type="number" name="sport_test_mark" readonly @if(isset($trialathleticsthrower)) readonly value="{{$trialathleticsthrower->sport_test_mark}}" @endif id="sport_test_mark{{$applicant->application_no}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 2px solid #868686;
					"></td>
                  <td><input type="number" name="total_obtain_mark" readonly @if(isset($trialathleticsthrower)) readonly value="{{$trialathleticsthrower->total_obtain_mark}}" @endif id="total_obtain_mark{{$applicant->application_no}}" style="
					width: 50px;
					font-weight: 400;
					background: none;
					border: 2px solid #868686;
                  ...
                  <td><input type="text" name="remark" @if(isset($trialathleticsthrower)) readonly value="{{$trialathleticsthrower->remark}}" @endif id="remark{{$applicant->application_no}}" style="
					...
					border: 1px solid #cdcdcd;
					"></td>
                  <td><input type="checkbox" id="checkathleticsthrower{{$applicant->application_no}}" @if(isset($trialathleticsthrower)) checked disabled @endif onChange="athleticsthrowerData({{$applicant->application_no}})" {{$applicant->
          application_no}} style="
          width: 50px;
          font-weight: 400;
          background: none;
          ...
          <table class="table text-center table-bordered" style="font-size: smaller;" id ='dataTablee'>
            <thead>
              <tr>
                <th rowspan="3" valign="top">क्रस </th>
                <th rowspan="3" valign="top">फार्म सं0</th>
              ...
              <th valign="top">आयु </th>
                ...
                <th  valign="top"rowspan="3" valign="top">
                    लिंग </th>

                <th rowspan="3" valign="top">परीक्षण स्थल</th>


                <th rowspan="3" valign="top">कक्षा जिसके लिए <br> प्रवेश चाह रहे हैं</th>
          ...
          <table id="notEligibleTable" class="table text-center table-bordered" style="font-size: smaller;">
            <thead>
                <tr>
                  <th >Name</th>
                </tr>
