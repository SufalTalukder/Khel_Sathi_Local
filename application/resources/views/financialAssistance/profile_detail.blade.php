                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="placeholder">Applicant's Full Name<br>आवेदक का पूरा नाम </label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="placeholder">Mother’s Name<br>माता का नाम<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="placeholder">Father’s Name<br>पिता का नाम<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label class="placeholder">Date of Birth<br>जन्म तिथि<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="placeholder">Place of Birth<br>जन्म स्थान<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Gender<br>लिंग<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="placeholder">Aadhaar Number<br>आधार नंबर<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6" style=" display: none; ">
                                <div class="form-group">
                                    ...
                                    <select name="association_certificate" required id="association_certificate" class="form-select">
                                        ...
                                        <option selected value="2" {{$user->association_certificate=="2" ? 'Selected':''}} {{ old('association_certificate') === "2" ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6" style="display:none">
                                <div class="form-group" id="association_approved_condition_hide_div">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="file" required name="signature" class="form-control" onchange="getfileext25(this,'T3')" id="FileT3" aria-describedby="inputGroupFileAddon05" aria-label="Upload">
                                    </div>
                                    <span class="note">(File Format: jpeg, jpg| Max File Size: 2 MB)<br>(फाइल का प्रारूप: JPEG/JPG | फाइल का अधिकतम साइज़: 2 MB)</span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="placeholder">Address<br>पता<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="placeholder">State<br>राज्य <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-12">
                            <h5 class="subheading">D. Permanent Address/स्थायी पता <small class="ms-3 text-dark"><input type="checkbox" name="same_as_currentaddress" id="same" value="yes" class="me-1">Same as current Address/वर्तमान पते के समान</small>
                            </h5>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="placeholder">State<br>राज्य<span class="text-danger">*</span></label>
                                    <select class="form-select dis_check" required name="permanent_state" style="pointer-events: none" id="state" onchange="get_city(this.value,'district')">
                                        <option value="">Select State</option>
                                        @foreach($state as $value)
...
<script>
    ...
    $(document).ready(function() {
        $('#association_certificate').change(function() {
            if ($(this).val() == 1) {
                $("#association_approved_condition_hide_div").show();
            } else {
                $("#association_approved_condition_hide_div").hide();
            }
        });
    });
</script>
