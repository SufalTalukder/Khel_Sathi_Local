                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="bhoechie-tab-content">
                        <div class="form-scroll">
                            <form action="{{route('save_monthlyPension')}}" method="post"  id="ajxReload"  enctype="multipart/form-data" class="needs-validation" novalidate="">
                                @csrf
                                <div>
                                    <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="file"  name="domicile_certificate" class="form-control" onchange="getfileext(this.value,1)" id="File1" aria-describedby="inputGroupFileAddon05" aria-label="Upload" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="honoured_award" required>
                                                    ...
                                                    <option {{ old('honoured_award') === "Khel Ratan Award" ? 'selected' : '' }} value="KhelRatan Award">Khel Ratan Award</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Year the award was won<br>किस वर्ष में अवार्ड जीता था?<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{old('bank_ifsc') }}" name="bank_ifsc" pattern="[A-Z]{4}0[A-Z0-9]{6}" required class="form-control" onblur="getBankDetails(this.value)" id="ifscupper">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input name="bank_branch" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))' pattern="^[A-Za-z -]+$" value="{{old('bank_branch') }}" required type="text" class="form-control" id="bank_branch">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
