            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                {{-- <tr>
                  ...
                  <td class="text-center"><a href="#" target="_blank" class="green external" rel="nofollow noopener noreferrer">Apply Now</a></td>
                  <td class="text-center"><a href="#" target="_blank" class="gray external" rel="nofollow noopener noreferrer">Check Status</a></td>
                </tr> --}}
              </tbody>
            </table>
          </div>
