        ...
        <div class="row">
            <div class="col-12">
                <div class="pageheader" id="menu-margin">
                    ...
                    <a href="dashboard.html" class="btn btn-outline-success btn-sm backbtn float-end "><span class="icons icon-arrow-left"></span>Back to Dashboard</a> </h4>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                        <div class="col-md-2 d-grid">
                                            <a data-bs-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1" class="btn btn-outline-success "><i class="fas fa-money-check"></i> Online Payment</a>
                                        </div>

                                        <div class="col-md-2 d-grid">
                                            <a  type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2" class="btn  btn-outline-info "><i class="fa">₹</i> Ofline Payment</a>
                                        </div>


                                        <div class="col-md-2 d-grid">
                                            <a href="" class="btn btn-outline-dark "><i class="fas fa-download"></i> Download Pay Slip</a>
                                        </div>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                ...
                                                <div class="card-footer" style="background: transparent;padding: 0;">
                                                    <a type="button" onclick="" class="subscribe btn btn-outline-danger w-100 "> Confirm Payment </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-pane" id="messages" role="tabpanel" aria-labelledby="messages-tab">
                                                ...
                                                <div class="form-group">
                                                    <a type="button" onclick="" class="btn-outline-primary btn w-100 "><i class="fas fa-mobile-alt mr-2"></i> Proceed Payment</a>
                                                </div>
                                    ...
                                    <div class="collapse multi-collapse" id="multiCollapseExample2">
                                        <h3>Pay Registration Fee <span class="text-danger"><i class="fa">₹</i>200</span></h3>
                                        ...
                                        <div class="mb-3">
                                            <a type="button" onclick="" class="btn btn-outline-primary w-100 "><i class="fas fa-tick mr-2"></i> Submit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
