...
<div class="container-fluid">
  ...
  <div class="row justify-content-center">
    <div class="col-4 col-lg-2 text-center mb-3"> <img src="{{ asset('facility_booking') }}/images/logo.png" class="img-fluid"> </div>
    ...
    <div class="col-md-12 col-12 deptname">
      <h4 class="text-danger">Registration of Pvt. Coaching Academies / Associations ,Gyms, Swimming Pools<br />
        निजी कोचिंग अकादमियों / संघों, जिम, और तरणताल का पंजीकरण</h4>
    </div>
  </div>
</div>
        <div class="col-md-6 bg-light1">
            <div class="p-4 p-lg-5 login-form">
                ...
                <form  id="preregister" action="{{route('private_coaching_forgot_password')}}"   class="mt-2 needs-validation" novalidate method="post">
                    ...
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-outline-success w-100" >Submit/दर्ज करे</button>
                         ...
                         <div class="col-md-6">
                       <a href="{{route('private_coaching_register')}}" class="small btn btn-outline-light w-100">Back/वापस</a>
