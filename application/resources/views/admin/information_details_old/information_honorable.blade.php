        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="container removebg-color" style="background: #f0e7eb;padding: 10px;margin-bottom: 10px;">
                    <form action="{{ asset('assets_admin/information/information_honorable') }}" class="needs-validation" method="get" novalidate
                        autocomplete="off">
                                    ...
                                    <tr>
                                        <th colspan="2">
                                            <div style="padding: 0 15px 3px; margin-bottom: 10px;  position: relative;">
                                                {{-- <img src="{{asset('public/assets_admin/images/logo.png')}}" style="width: 75px; height: auto; position: absolute; top: 0px; left: 20px;">
