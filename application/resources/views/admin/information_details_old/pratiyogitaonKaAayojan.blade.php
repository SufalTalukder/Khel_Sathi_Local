        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-12">
                        <fieldset>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> आयोजन तिथि <span class="text-danger">*</span></label>
                ...
                <div class="container removebg-color" style="background: #f0e7eb;padding: 10px;margin-bottom: 10px;">
                    <form action="{{ asset('assets_admin/information/pratiyogitaonKaAayojan') }}" class="needs-validation" method="get" novalidate
                        autocomplete="off">
