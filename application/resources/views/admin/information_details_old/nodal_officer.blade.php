...
<div class="row">
    <div class="col-12">
        <div class="pageheader" id="menu-margin">
            <h4 class="mb-0">विभागाध्यक्ष- निदेशक, खेल, खेल निदेशालय, उ0प्र0, लखनऊ
                <a title="Print" class="btn btn btn-outline-success float-end" data-print="modal"
                    ...
                    <button onclick="PrintExce('Nodal Officer')" class="btn btn btn-outline-primary float-end">Excel</button>
            </h4>
        </div>
    </div>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{url('admin/information/nodal_officer')}}" class="needs-validation"
                    ...
                    <fieldset>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="placeholder">कार्यालयाध्यक्ष का नाम <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="head_office_name"  @if(isset($ed_data->head_office_name) ) value="{{$ed_data->head_office_name}}" @endif class="form-control" required />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="placeholder">जनपद का नाम<span
                                            class="text-danger">*</span></label>
                            ...
                            <b>नामित नोडल अधिकारी का नाम</b>
                            <hr>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="placeholder">नाम<span class="text-danger">*</span></label>
                                    <input type="text" name="officer_name" @if(isset($ed_data->officer_name) ) value="{{$ed_data->officer_name}}" @endif class="form-control"
                                        required />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="placeholder">पदनाम<span
                                            class="text-danger">*</span></label>
                                    <input ttype="text" name="officer_designation" @if(isset($ed_data->officer_designation) ) value="{{$ed_data->officer_designation}}" @endif
                                        class="form-control" required />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="placeholder">मोबाइल नं.<span
                                            class="text-danger">*</span></label>
                                    <input pattern="[6-9][0-9]{9}$" maxlength="10"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="officer_mobile" @if(isset($ed_data->officer_mobile) ) value="{{$ed_data->officer_mobile}}" @endif class="form-control" required />
                                </div>
                            </div>
                        </div>
                ...
                <div class="container removebg-color" style="background: #f0e7eb;padding: 10px;margin-bottom: 10px;">
                    <form action="{{ asset('assets_admin/information/nodal_officer') }}" class="needs-validation" method="get" novalidate
                        autocomplete="off">
                        <div class="pageheaderr">
                            <div class="row">
                                ...
                                <div class="col-md-1 custom-buton" style="padding-top: 1.4rem;">
                                    <a class="btn btn-primary btn-sm" href="{{url('admin/information/nodal_officer')}}"><i class="fas fa-refresh"></i></a>
                                </div>
                            </div>
                        </div>
                    </form>
                                        ...
                                        <th colspan="2">
                                            <div style="padding: 0 15px 3px; margin-bottom: 10px;  position: relative;">
                                                ...
                                                <h2 style="text-align: center; margin:0px 0px 0px 0px; font-size:14pt; padding: 0px; color:#383838; font-weight: bold;">
                                                    मा0 सांसद एवं विधान मण्डन के मा0 सदस्यों के पत्रों पर प्रभावी/निश्चित<br />कार्यवाही किये जाने हेतु नामित नोडल अधिकारी से सम्बन्धित सूचना
                                                </h2>
                                            </div>
                                            <h6 style="text-align: center; margin:10px 0px 15px 0px; font-size:12pt; padding: 0px; color:#383838; font-weight: bold; text-decoration:underline;">
                                                विभागाध्यक्ष- निदेशक, खेल, खेल निदेशालय, उ0प्र0, लखनऊ
                                            </h6>
                                        </th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th style="font-size: 10pt; text-align:right">
                                            {{-- <strong>Report Period : </strong> {{first_insert('information_nodal_officer','created_on')}} to {{date("d-m-Y")}} --}}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <td colspan="2">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover bg-white datatable mb-3" id="dataTable" cellpadding="3">
                                                    <thead>
                                                        <tr role="row">
                                                            <th rowspan="2" colspan="1">क्र.सं.</th>
                                                            <th rowspan="2" colspan="1">माह</th>
                                                            <th rowspan="2" colspan="1">वर्ष</th>
                                                            <th rowspan="2" colspan="1">कार्यालयाध्यक्ष का नाम</th>
                                                            <th rowspan="2" colspan="1">मण्डल का नाम</th>
                                                            <th rowspan="2" colspan="1">जनपद का नाम</th>
                                                            <th colspan="3" style="text-align:center;" rowspan="1">नामित नोडल अधिकारी का नाम</th>
                                                            <th rowspan="2" colspan="1" class="noprint">Action</th>
                                                        </tr>
                                                        <tr role="row">
                                                            <th rowspan="1" colspan="1">नाम</th>
                                                            <th rowspan="1" colspan="1">पदनाम</th>
                                                            <th rowspan="1" colspan="1">मोबाइल नं.</th>
                                                        </tr>

                                                    </thead>
                                                    @foreach($nodal_officer as $key=>$item)
                                                    <tr>
                                                        <td>{{$key+1}}</td>
                                                        ...
                                                        <td>{{$item->officer_designation}}</td>
                                                        <td>{{$item->officer_mobile}}</td>
                                                        <td class="text-center noprint">
                                                            <a class="btn btn-sm btn-dark pointer bt" href="{{ route('nodal_officer' , $item->id) }}">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        
                                                            <a class="btn btn-sm btn-danger pointer bt" href="{{ route('delete_inf' , [$item->id,'information_nodal_officer']) }}" onclick="return confirm('Are you sure you want to delete ?')">
