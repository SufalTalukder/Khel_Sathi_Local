...
<div class="row">
    <div class="col-12">
        <div class="pageheader" id="menu-margin">
            <h4 class="mb-0">
                बिन्दु-04 - आवासीय क्रीड़ा छात्रावास
                ...
                <button onclick="PrintExce('Kreeda Chatravas')" class="btn btn btn-outline-primary float-end">Excel</button>
            </h4>
        </div>
    </div>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="reload_two" action="{{url('admin/information/kreeda_chatravas')}}" class="needs-validation" novalidate method="post" autocomplete="off">
                    @csrf
                    <div class="col-12">
                        <fieldset>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder">स्वीकृत संख्या <span class="text-danger">*</span></label>
                                        <input name="accepted_number" @if(isset($ed_data->accepted_number) ) value="{{$ed_data->accepted_number}}" @endif required type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/(\.\d{2}).+/g, '$1');" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder">वर्तमान संख्या <span class="text-danger">*</span></label>
                                        <input name="current_number" @if(isset($ed_data->current_number) ) value="{{$ed_data->current_number}}" @endif required type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/(\.\d{2}).+/g, '$1');" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                ...
                <div class="container removebg-color" style="background: #f0e7eb;padding: 10px;margin-bottom: 10px;">
                    <form action="{{ asset('assets_admin/information/kreeda_chatravas') }}" class="needs-validation" method="get" novalidate
                        autocomplete="off">
                        <div class="pageheaderr">
                            <div class="row">
                                ...
                                <div class="col-md-1 custom-buton" style="padding-top: 1.4rem;">
                                    <a class="btn btn-primary btn-sm" href="{{url('admin/information/kreeda_chatravas')}}"><i class="fas fa-refresh"></i></a>
                                </div>
                            </div>
                        </div>
                    </form>
                                ...
                                <thead class="dn">
                                    ...
                                    <tr>
                                        ...
                                        <th style="font-size: 10pt; text-align:right">
                                            <strong>Report Period : </strong> {{first_insert('information_kreeda_chatravas','created_at')}} to {{date("d-m-Y")}}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                                ...
                                                <table class="table table-bordered table-hover bg-white mb-3" id="dataTable" cellpadding="3">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th rowspan="2">स्वीकृत संख्या</th>
                                                            <th rowspan="2">वर्तमान संख्या</th>
                                                    ...
                                                    <tbody>
                                                        <?php $t_accepted_number = 0;
                                                        $t_current_number = 0;
                                                        $t_national_achievement = 0;
                                                        $t_international_achievement = 0;
                                                        ?>
                                                        @foreach($kreeda_chatravas as $key=>$item)
                                                        <tr>
                                                            <td>{{$key+1}}</td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <?php $t_accepted_number += $item->accepted_number ?>
                                                                {{$item->accepted_number}}
                                                            </td>
                                                            <td>
                                                                <?php $t_current_number += $item->current_number ?>
                                                                {{$item->current_number}}
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="text-center noprint">
                                                                <a class="btn btn-sm btn-dark pointer bt" href="{{ route('kreeda_chatravas' , $item->id) }}">
                                                                <i class="fa fa-edit"></i>
                                                            </a>
                                                            
                                                                <a class="btn btn-sm btn-danger pointer bt" href="{{ route('delete_inf' , [$item->id,'information_kreeda_chatravas']) }}" onclick="return confirm('Are you sure you want to delete ?')">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;</td>
                                                            <td><b>योग</b></td>
                                                            <td><b>{{$t_accepted_number}}</b></td>
                                                            <td><b>{{$t_current_number}}</b></td>
                                                            <td><b>{{$t_national_achievement}}</b></td>
                                                            <td><b>{{$t_international_achievement}}</b></td>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                </table>
                                            </div>
