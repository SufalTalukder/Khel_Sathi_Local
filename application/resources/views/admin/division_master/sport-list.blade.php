...
<div class="row">
	<div class="col-md-12">
		...
		<div class="card mb-3">
			<div class="card-body">
				<form action="{{ route('saveSport') }}" class="needs-validation" method="post" novalidate>
					@csrf
					<div class="row">
						<div class="col-md-3">
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="{{ route('updateSport') }}" class="needs-validation" method="post" autocomplete="off">
					@csrf
	...
	<script type="text/javascript">
		...
		function reloadContainer() {
			...
			window.location.href = "admin/sport-list";
		}
