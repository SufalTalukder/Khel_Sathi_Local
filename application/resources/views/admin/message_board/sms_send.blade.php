...
<div class="card mb-3">
	...
	<div class="card-body">
		<form action="{{ route('send_sms') }}" id="save_Template" class="needs-validation" method="post" autocomplete="off" novalidate>
...
<div class="row">
	...
	<div class="col-md-12 TEMPLATE_CONMTENT" style="display: none;">
		<div class="form-group">
			<label for="TEMPLATE_CONMTENT" class="placeholder"> TEMPLATES CONTENTS </label>
				...
				<div class="col-md-12" id="new_user_child" style="display: none;">
					...
					<div class="col-md-6">
						<div class="form-group mt-2">
							...
							<a href="{{url('public/sample.csv')}}" class="form-control  mt-2">DOWNLOAD SAMPLE</a>
						</div>
					</div>
				</div>
				</div>
