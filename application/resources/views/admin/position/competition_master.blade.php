...
<div class="pageheader" id="menu-margin">
	<h4 class="mb-0">Competition Master
	</h4>
</div>
<div class="card">
	<div class="card-body">
		<form action="{{ asset('assets_admin/addPositionComp') }}" class="needs-validation" id="inventory" novalidate method="post">
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="invalid-feedback">
							Please provide a competition name.
						</div>
					</div>
				</div>
				<div class="col-md-2">
...
<div class="pageheader" id="menu-margin">
	<h4 class="mb-0">Competition Master List
		<a title="Competition Master List" class="btn btn-sm btn-success float-end alphanumeric" onclick="ExportToExcel('xlsx')"><i class="fa fa-file-excel"></i> Export to Excel
		</a>
	</h4>
</div>
<div class="card">
		...
		<div class="">
			<div class="table-responsive">
				<table id="dataTable" class="table table-bordred table-hover bg-white datatable">
					...
					<tbody>
						@foreach($position_comp as $key=>$item)
						<tr>
							<td>{{ $key+1 }}</td>
							<td>
							...
							<td class="text-center">
								...
								<a style="display:none;" class="btn btn-sm btn-info state{{$item->id}}" href="javascript:void(0)" onclick="updateCompet('{{$item->id}}')">
									Update
								</a>
							</td>
						</tr>
