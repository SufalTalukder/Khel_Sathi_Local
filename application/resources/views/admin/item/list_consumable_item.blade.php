				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							<div class="row">
								<div class="col-md-10">
									<h5> Details of Added Consumable Assets</h5>
								</div>
								<div class="col-md-2">
									 <a  href="{{route('addConsumableItem')}}" title="Consumable Master List" class="btn btn-sm btn-primary">
									...
									<table  id="dataTable" class="table table-bordred table-hover bg-white datatable" >
										...
										<tbody>
											...
											<tr>
												...
												<a class="btn btn-sm btn-dark pointer bt" href="{{ route('addConsumableItem' , $item->id) }}">
													<i class="fa fa-edit"></i>
												</a>
												<a class="btn btn-sm btn-danger pointer bt"
													href="{{ route('deleteConsumableItem' , $item->id) }}" 
