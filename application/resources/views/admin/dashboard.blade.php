    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <a href="FormerSportsPerson.html" class="btn btn-primary">View Report</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <a href="AwardList.html" class="btn btn-primary">View Report</a>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <a href="NationalInternationalLevelRecord.html" class="btn btn-primary">View Report</a>
            </div>
        </div>
    </div>
</div>
