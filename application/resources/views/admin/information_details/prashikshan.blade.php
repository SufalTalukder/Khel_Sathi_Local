    ...
    <div class="col-12">
        <div class="pageheader" id="menu-margin">
            <h4 class="mb-0">
                ...
                <button onclick="PrintExce('Prasikshan Shivir')" class="btn btn btn-outline-primary float-end">Excel</button>
            </h4>
        </div>
    </div>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="reload_two" action="{{url('admin/information/prashikshan')}}" class="needs-validation" novalidate method="post" autocomplete="off">
                    @csrf
                    <div class="col-12">
                        <fieldset>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-select" name="sport_id" required>
                                            ...
                                            <option value="{{$item->id}}" @if(isset($ed_data->sport_id) && ($ed_data->sport_id==$item->id)) selected @endif>{{$item->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder">प्रशिक्षक के नाम <span class="text-danger">*</span></label>
                                        <input type="text" name="instructor_name" @if(isset($ed_data->instructor_name) ) value="{{$ed_data->instructor_name}}" @endif required class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> विभागीय/अंशकालिक <span class="text-danger">*</span></label>
                                        <div class="form-control">
                                            <label class="mb-0 me-3">विभागीय &nbsp; <input type="radio" name="departmental_part_time" @if(isset($ed_data->departmental_part_time) && $ed_data->departmental_part_time == 1) checked @endif required value="1" /></label>
                                            <label class="mb-0">अंशकालिक &nbsp; <input type="radio" name="departmental_part_time" @if(isset($ed_data->departmental_part_time) && $ed_data->departmental_part_time == 2) checked @endif value="2" /></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> मानक संख्या <span class="text-danger">*</span></label>
                                        <input name="standard_number" @if(isset($ed_data->standard_number) ) value="{{$ed_data->standard_number}}" @endif required type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/(\.\d{2}).+/g, '$1');" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> वर्तमान बालक की संख्या <span class="text-danger">*</span></label>
                                        <input name="current_boys" @if(isset($ed_data->current_boys) ) value="{{$ed_data->current_boys}}" @endif id="current_boys" onblur="totalnum()" required type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/(\.\d{2}).+/g, '$1');" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> वर्तमान बालिका की संख्या <span class="text-danger">*</span></label>
                                        <input name="current_girls" @if(isset($ed_data->current_girls) ) value="{{$ed_data->current_girls}}" @endif id="current_girls" onblur="totalnum()" required type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/(\.\d{2}).+/g, '$1');" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> बालक और बालिका की संख्या का योग <span class="text-danger">*</span></label>
                                        <input type="text" name="sum_boys_girls" @if(isset($ed_data->sum_boys_girls) ) value="{{$ed_data->sum_boys_girls}}" @endif id="sum_boys_girls" class="form-control" readonly />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> राष्ट्रीय उपलब्धि</label>
                                        <input name="national_achievement" @if(isset($ed_data->national_achievement) ) value="{{$ed_data->national_achievement}}" @endif required type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/(\.\d{2}).+/g, '$1');" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder">अंतरराष्ट्रीय उपलब्धि</label>
                                        <input name="international_achievement" @if(isset($ed_data->international_achievement) ) value="{{$ed_data->international_achievement}}" @endif required type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/(\.\d{2}).+/g, '$1');" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                ...
                <div class="container removebg-color" style="background: #f0e7eb;padding: 10px;margin-bottom: 10px;">
                    <form action="{{ url('admin/information/prashikshan') }}" class="needs-validation" method="get" novalidate
                        autocomplete="off">
                        <div class="pageheaderr">
                            <div class="row">
                                ...
                                <div class="col-md-1 custom-buton" style="padding-top: 1.4rem;">
                                    <a class="btn btn-primary btn-sm" href="{{url('admin/information/prashikshan')}}"><i class="fas fa-refresh"></i></a>
                                </div>
                            </div>
                        </div>
                    </form>
                                ...
                                <thead class="dn">
                                    ...
                                    <tr>
                                        ...
                                        <th style="font-size: 10pt; text-align:right">
                                            <strong>Report Period : </strong> {{first_insert('information_prashikshan','created_at')}} to {{date("d-m-Y")}}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                                ...
                                                <table class="table table-bordered table-hover bg-white mb-3" id="dataTable" cellpadding="3">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th rowspan="2">मण्डल</th>
                                                            <th rowspan="2">जनपद</th>
                                                            <th rowspan="2">माह</th>
                                                            <th rowspan="2">वर्ष</th>
                                                            <th rowspan="2">खेल का नाम</th>
                                                            <th rowspan="2">प्रशिक्षक के नाम</th>
                                                            <th rowspan="2">
                                                                विभागीय/अंशकालिक
                                                            </th>
                                                            <th rowspan="2">मानक संख्या</th>
                                                            <th colspan="3" style="text-align:center">वर्तमान संख्या</th>
                                                            <th colspan="2" style="text-align:center">उपलब्धि</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>योग</th>
                                                            <th>राष्ट्रीय</th>
                                                            <th>अन्तर्राष्ट्रीय </th>
                                                        </tr>

                                                    </thead>
                                                    <tbody>
                                                        <?php $t_current_boys = 0;
                                                        $t_current_girls = 0;
                                                        $t_sum_boys_girls = 0;
                                                        $t_national_achievement = 0;
                                                        $t_international_achievement = 0;
                                                        ?>
                                                        @foreach($prashikshan as $key=>$item)
                                                        <tr>
                                                            <td>{{$key+1}}</td>
                                                            <td>
                                                            ...
                                                            <td>{{repairHindi($item->instructor_name)}}</td>
                                                            <td>@if($item->departmental_part_time==1)
                                                                विभागीय @else अंशकालिक @endif
                                                            </td>
                                                            <td>{{$item->standard_number}}</td>
                                                            <td>
                                                                <?php $t_current_boys += $item->current_boys ?>
                                                                {{$item->current_boys}}
                                                            </td>
                                                            <td>
                                                                <?php $t_current_girls += $item->current_girls ?>
                                                                {{$item->current_girls}}
                                                            </td>
                                                            <td>
                                                                <?php $t_sum_boys_girls += $item->sum_boys_girls ?>
                                                                {{$item->sum_boys_girls}}
                                                            </td>
                                                            <td>
                                                                <?php $t_national_achievement += $item->national_achievement ?>
                                                                {{$item->national_achievement}}
                                                            </td>
                                                            <td>
                                                                <?php $t_international_achievement += $item->international_achievement ?>
                                                                {{$item->international_achievement}}
                                                            </td>
                                                            <td>{{repairHindi($item->comment)}}</td>
                                                            <td class="text-center noprint">
                                                                <a class="btn btn-sm btn-dark pointer bt" href="{{ route('prashikshan' , $item->id) }}">
                                                                <i class="fa fa-edit"></i>
                                                            </a>
                                                            
                                                                <a class="btn btn-sm btn-danger pointer bt" href="{{ route('delete_inf' , [$item->id,'information_prashikshan']) }}" onclick="return confirm('Are you sure you want to delete ?')">
                                                        ...
                                                        <tr>
                                                            <td colspan="9"><b>कुल योग-</b></td>
                                                            <td><b>{{$t_current_boys}}</b></td>
                                                            <td><b>{{$t_current_girls}}</b></td>
                                                            <td><b>{{$t_sum_boys_girls}}</b></td>
                                                            <td>{{$t_national_achievement}}</td>
                                                            <td>{{$t_international_achievement}}</td>
                                                            <td>&nbsp;</td>
                                                        </tr>
                                                </table>
                                            </div>
...
<script>
    ...
    function totalnum(val) {
        $('#sum_boys_girls').val(parseInt($('#current_girls').val()) + parseInt($('#current_boys').val()));
    }
</script>
@endpush
