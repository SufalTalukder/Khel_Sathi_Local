...
<div class="row">
    <div class="col-12">
        <div class="pageheader" id="menu-margin">
            <h4 class="mb-0">
                बिन्दु-07 - क्रीडा प्रतियोगिता का आयोजन
                ...
                <button onclick="PrintExce('Pratiyogitaon Ka Aayojan')" class="btn btn btn-outline-primary float-end">Excel</button>
            </h4>
        </div>
    </div>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="reload_two" action="{{url('admin/information/pratiyogitaonKaAayojan')}}" class="needs-validation" novalidate method="post" autocomplete="off">
                    @csrf
                    <div class="col-12">
                        <fieldset>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder">प्रतियोगिता का नाम <span class="text-danger">*</span></label>
                                        <input type="text" required name="competition_name" @if(isset($ed_data->competition_name) ) value="{{$ed_data->competition_name}}" @endif class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> आयोजन तिथि </label>
                                        <input type="date" name="event_date" @if(isset($ed_data->event_date) ) value="{{$ed_data->event_date}}" @endif class="form-control " />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> बालक प्रतिभागियों की संख्या <span class="text-danger">*</span></label>
                                        <input type="text" id="participants_boys" onblur="totalnum()" name="participants_boys" @if(isset($ed_data->participants_boys) ) value="{{$ed_data->participants_boys}}" @endif required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/(\.\d{2}).+/g, '$1');" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> बालिका प्रतिभागियों की संख्या <span class="text-danger">*</span></label>
                                        <input type="text" id="participants_girls" onblur="totalnum()" name="participants_girls" @if(isset($ed_data->participants_girls) ) value="{{$ed_data->participants_girls}}" @endif required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/(\.\d{2}).+/g, '$1');" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> बालक और बालिका प्रतिभागियों का योग <span class="text-danger">*</span></label>
                                        <input type="text" id="participants_total" name="participants_total" @if(isset($ed_data->participants_total) ) value="{{$ed_data->participants_total}}" @endif class="form-control" readonly />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> व्यय का श्रोत (विभागीय अथवा स्पांशरशिप (स्पाशंर का नाम)) </label>
                                        <input type="text" name="sponsor_name" @if(isset($ed_data->sponsor_name) ) value="{{$ed_data->sponsor_name}}" @endif class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder"> व्यय की गयी धनराशि <span class="text-danger">*</span></label>
                                        <input type="text" name="amount_spent" @if(isset($ed_data->amount_spent) ) value="{{$ed_data->amount_spent}}" @endif required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/(\.\d{2}).+/g, '$1');" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="placeholder">वितरित किये गये पुरस्कार से सम्बन्धित विवरण</label>
                ...
                <div class="container removebg-color" style="background: #f0e7eb;padding: 10px;margin-bottom: 10px;">
                    <form action="{{ url('admin/information/pratiyogitaonKaAayojan') }}" class="needs-validation" method="get" novalidate
                        autocomplete="off">
                        <div class="pageheaderr">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="col-md-1 custom-buton" style="padding-top: 1.4rem;">
                                    <a class="btn btn-primary btn-sm" href="{{url('admin/information/pratiyogitaonKaAayojan')}}"><i class="fas fa-refresh"></i></a>
                                </div>
                            </div>
                        </div>
                    </form>
                                ...
                                <thead class="dn">
                                    ...
                                    <tr>
                                        ...
                                        <th style="font-size: 10pt; text-align:right">
                                            <strong>Report Period : </strong> {{first_insert('information_pratiyogitaonkaaayojan','created_at')}} to {{date("d-m-Y")}}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                                ...
                                                <table class="table table-bordered table-hover bg-white mb-3" id="dataTable" cellpadding="3">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th rowspan="2">प्रतियोगिता का नाम</th>
                                                            <th rowspan="2">आयोजन तिथि</th>
                                                            <th colspan="3" style="text-align:center;">प्रतिभागियों की संख्या</th>
                                                            <th rowspan="2">व्यय का श्रोत (विभागीय अथवा स्पांशरशिप (स्पाशंर का नाम))</th>
                                                            <th rowspan="2">व्यय की गयी धनराशि</th>
                                                            <th rowspan="2">वितरित किये गये पुरस्कार से सम्बन्धित विवरण</th>
                                                    ...
                                                    <tbody>
                                                        <?php $t_participants_boys = 0;
                                                        $t_participants_girls = 0;
                                                        $t_participants_total = 0;
                                                        $t_amount_spent = 0;
                                                        ?>
                                                        @foreach($pratiyogitaonKaAayojan as $key=>$item)
                                                        <tr>
                                                            <td>{{$key+1}}</td>
                                                            <td>
                                                            ...
                                                            <td>{{$item->year}}</td>
                                                            <td>{{repairHindi($item->competition_name)}}</td>
                                                            <td>@if($item->event_date){{dmy($item->event_date)}}@else NA @endif</td>
                                                            <td>
                                                                <?php $t_participants_boys += $item->participants_boys ?>
                                                                {{$item->participants_boys}}
                                                            </td>
                                                            <td>
                                                                <?php $t_participants_girls += $item->participants_girls ?>
                                                                {{$item->participants_girls}}
                                                            </td>
                                                            <td>
                                                                <?php $t_participants_total += $item->participants_total ?>
                                                                {{$item->participants_total}}
                                                            </td>
                                                            <td>{{repairHindi($item->sponsor_name)}}</td>
                                                            <td>
                                                                <?php $t_amount_spent += $item->amount_spent ?>
                                                                {{$item->amount_spent}}
                                                            </td>
                                                            <td>{{repairHindi($item->comment)}}</td>
                                                            <td class="text-center noprint">
                                                                <a class="btn btn-sm btn-dark pointer bt" href="{{ route('pratiyogitaonKaAayojan' , $item->id) }}">
                                                                <i class="fa fa-edit"></i>
                                                            </a>
                                                            
                                                                <a class="btn btn-sm btn-danger pointer bt" href="{{ route('delete_inf' , [$item->id,'information_pratiyogitaonkaaayojan']) }}" onclick="return confirm('Are you sure you want to delete ?')">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{$t_participants_boys}}</td>
                                                            <td>{{$t_participants_girls}}</td>
                                                            <td>{{$t_participants_total}}</td>
                                                            <td>&nbsp;</td>
                                                            <td>{{$t_amount_spent}}</td>
                                                            <td>&nbsp;</td>
                                                        </tr>
...
<script>
    ...
    function totalnum() {
        $('#participants_total').val(parseInt($('#participants_girls').val()) + parseInt($('#participants_boys').val()));
    }
</script>
@endpush
