...
<div class="row">
    <div class="col-12">
        <div class="pageheader" id="menu-margin">
            <h4 class="mb-0">
                बिन्दु-06 - "एक जिला एक खेल" योजना के तहत खेलो इण्डिया सेन्टर संचालित किए जाने सम्बन्धी सूचना
                ...
                <button onclick="PrintExce('Khelo India Center')" class="btn btn btn-outline-primary float-end">Excel</button>
            </h4>
        </div>
    </div>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="reload_two" action="{{url('admin/information/kheloindiyacentar')}}" class="needs-validation" novalidate method="post" autocomplete="off">
                    @csrf
                    <div class="col-12">
                        <fieldset>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="comment"  @if(isset($ed_data->comment) ) value="{{repairHindi($ed_data->comment)}}" @endif class="form-control" />
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container removebg-color" style="background: #f0e7eb;padding: 10px;margin-bottom: 10px;">
                    <form action="{{ url('admin/information/kheloindiyacentar') }}" class="needs-validation" method="get" novalidate
                        autocomplete="off">
                        <div class="pageheaderr">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="col-md-1 custom-buton" style="padding-top: 1.4rem;">
                                    <a class="btn btn-primary btn-sm" href="{{url('admin/information/kheloindiyacentar')}}"><i class="fas fa-refresh"></i></a>
                                </div>
                            </div>
                        </div>
                    </form>
                                ...
                                <thead class="dn">
                                        ...
                                        <th colspan="2">
                                            <div style="padding: 0 15px 3px; margin-bottom: 10px; border-bottom: 0px solid #000; position: relative;">
                                                ...
                                                <h2 style="text-align: center; margin:0px 0px 0px 0px; font-size:14pt; padding: 0px; color:#383838; font-weight: bold;">
                                                    "एक जिला एक खेल" योजना के तहत खेलो इण्डिया सेन्टर संचालित किए जाने सम्बन्धी सूचना
                                                </h2>
                                            </div>
                                        </th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th style="font-size: 10pt; text-align:right">
                                            <strong>Report Period : </strong> {{first_insert('information_kheloindiyacentar','created_at')}} to {{date("d-m-Y")}}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <td colspan="2">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover bg-white mb-3" id="dataTable" cellpadding="3">
                                                    ...
                                                    <tbody>
                                                        @foreach($kheloindiyacentar as $key=>$item)
                                                        <tr>
                                                            <td>{{$key+1}}</td>
                                                            <td>
                                                            ...
                                                            <td class="text-center noprint">
                                                                <a class="btn btn-sm btn-dark pointer bt" href="{{ route('kheloindiyacentar' , $item->id) }}">
                                                                <i class="fa fa-edit"></i>
                                                            </a>
                                                            
                                                                <a class="btn btn-sm btn-danger pointer bt" href="{{ route('delete_inf' , [$item->id,'information_kheloindiyacentar']) }}" onclick="return confirm('Are you sure you want to delete ?')">
