        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="container removebg-color" style="background: #f0e7eb;padding: 10px;margin-bottom: 10px;">
                    <form action="{{ url('admin/information/rajasv_praptiya') }}" class="needs-validation" method="get" novalidate
                        autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input readonly name="from_date" value="{{request()->input('from_date')}}" onchange="handeChange(this)" id="from_date" type="text" required class="form-control dateTime" placeholder="From Date" data-language="en">
                                    </div>
                                    <div class="col-md-2">
                                        <label for="to_date">To Date</label>
                                        <input readonly name="to_date" value="{{request()->input('to_date')}}" id="to_date" onchange="handeChange(this)" type="text" required class="form-control dateTime" placeholder="To Date" data-language="en">
                                    </div>
                                ...
                                <tr>
                                    <th style="font-size: 10pt; text-align: left;">
                                        <?php 
                                            ...
                                            $fromYear = $fromMonth = $toYear = $toMonth = null;

                                            if ($fromDateInput) {
                                                $from = DateTime::createFromFormat('d-m-Y', $fromDateInput);
                                                if ($from !== false) {
                                            ...
                                            if ($toDateInput = request()->input('to_date')) {
                                                $to = DateTime::createFromFormat('d-m-Y', $toDateInput);
                                                if ($to !== false) {
                                                    $toYear = $to->format('Y');
                                                    $toMonth = $to->format('m');
                                                } else {
                                                    // Optional: handle invalid date format for to_date here
                                                    // e.g., log error or set defaults
                                                }
                                            }


                                        ?>
                                        <b>Year :</b>  {{$fromMonth ? month_name($fromMonth):month_name(date("m"))}} - {{$fromYear ? $fromYear:date("Y")}}    to   {{$toMonth ? month_name($toMonth):month_name(date("m"))}} - {{$toYear ? $toYear:date("Y")}}  
                                    </th>
