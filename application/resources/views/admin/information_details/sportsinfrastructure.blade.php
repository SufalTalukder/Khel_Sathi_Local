...
<div class="row">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form <?php if ($admin_id == 1) { ?> style="display:none" <?php } ?> action="{{url('admin/information/create_sportsinfra')}}" class="needs-validation" novalidate method="post" autocomplete="off">
                    @csrf
                    <fieldset>
                        <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control">
                                            <div class=" form-check-inline">
                                                ...
                                                <label class="form-check-label mb-0" for="inlineCheckbox1">ज़िला
                                                </label>
                                            </div>
                                            <div class=" form-check-inline">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label class="placeholder">स्थापित खेल अवस्थापना का नाम<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label class="placeholder">स्थापित किये जाने का वर्ष<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label class="placeholder">खेल अवस्थापना लागत<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label class="placeholder">निष्पादन एजेंसी का नाम<span class="text-danger">*</span></label>
                    ...
                    <table class="table table-bordered table-hover bg-white datatable mb-3" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <?php if ($admin_id == 10) { ?>
                                    <th>
                                        <p align="center"><strong>मण्डल</strong><strong> </strong><strong>का नाम</strong></p>
                                    </th>
                                    <th><strong>स्थापित खेल अवस्थापना का नाम</strong></th>
                                    <th><strong>स्थापित किये जाने का वर्ष</strong></th>
                                    <th>खेल अवस्थापना लागत</th>
                                    <th>निष्पादन एजेंसी का नाम</th>
                                <?php } ?>
                                <?php if ($admin_id == 9) { ?>
                                    <th>जिले का नाम</th>
                                    <th>तहसील का नाम</th>
                        ...
                        <tbody>
                            @foreach($sportsInfrastructure as $key=>$item)
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <?php
                                //1 District
                                ...
                                <?php } ?>
                                <td>{{isset($item->name_of_game_setup) ? repairHindi($item->name_of_game_setup) : '-' }}</td>
                                ...
                                <td>{{isset($item->name_of_executing_agency) ? repairHindi($item->name_of_executing_agency) : '-' }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
