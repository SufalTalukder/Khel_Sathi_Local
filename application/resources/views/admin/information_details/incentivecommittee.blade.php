                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <?php if ($item->status == 0) { ?>
                                 ...
                                 <td><b>Bank Name: </b>{{isset($item->bank_name) ? repairHindi($item->bank_name) : '-' }}<br><b>Branch: </b>{{isset($item->branch_name) ? repairHindi($item->branch_name) : '-' }}<br><b>A/C Holder: </b>{{isset($item->account_holder_name) ? repairHindi($item->account_holder_name) : '-' }}</td>
                              <?php } ?>
                              <?php //1 District
                              if ($item->status == 1) { ?>
