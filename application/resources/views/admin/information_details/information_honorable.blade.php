...
<div class="row">
    <div class="col-12">
        <div class="pageheader" id="menu-margin">
            <h4 class="mb-0">मा0 सांसद एवं विधान मण्डल के मा0 सदस्यों के पत्रों पर प्रभावी एवं निश्चित कार्यवाही का प्रभावी अनुश्रवण करने विषयक सूचना
                <a title="Print" class="btn btn btn-outline-success float-end" data-print="modal"
                    ...
                    <button onclick="PrintExce('Information Honorable')" class="btn btn btn-outline-primary float-end">Excel</button>
            </h4>
        </div>
    </div>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{url('admin/information/information_honorable')}}" class="needs-validation"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <select name="district_name" required id="district_name" class="form-control form-select">
                                        <option value="">--select--</option>
                                        @foreach($districts as $key=>$district)
                                        <option value="{{$district->id}}" @if(isset($ed_data->district_id) && ($ed_data->district_id==$district->id)) selected @endif>{{$district->city}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="name_of_honorable" pattern="^[A-Za-z -]+$" maxlength="150" name="name_of_honorable" @if(isset($ed_data->name_of_honorable) ) value="{{$ed_data->name_of_honorable}}" @endif class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label class="placeholder">पत्र प्राप्त होने की तिथि </label>
                                    <input type="date" id="date_of_receipt_of_letter" name="date_of_receipt_of_letter" @if(isset($ed_data->date_of_receipt_of_letter) ) value="{{ymd($ed_data->date_of_receipt_of_letter)}}" @endif class="form-control " data-language="en">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label class="placeholder">पत्र का विषय <span class="text-danger">*</span></label>
                                    <input type="text" id="subject_of_letter" pattern="^[A-Za-z -]+$" maxlength="255" name="subject_of_letter" @if(isset($ed_data->subject_of_letter) ) value="{{$ed_data->subject_of_letter}}" @endif class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label class="placeholder">कृत कार्यवाही का विवरण <span class="text-danger">*</span></label>
                                    <input type="text" id="details_of_action_taken" pattern="^[A-Za-z -]+$" maxlength="255" name="details_of_action_taken" @if(isset($ed_data->details_of_action_taken) ) value="{{$ed_data->details_of_action_taken}}" @endif class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label class="placeholder">मा. सदस्य को कृत कार्यवाही से अवगत कराने की तिथि </label>
                                    <input type="date" id="date_of_informing_honble_mp" name="date_of_informing_honble_mp" @if(isset($ed_data->date_of_informing_honble_mp) ) value="{{ymd($ed_data->date_of_informing_honble_mp)}}" @endif class="form-control " data-language="en" >
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label class="placeholder">मा. सदस्य को कृत कार्यवाही से अवगत न कराये जाने का कारण<span class="text-danger">*</span></label>
                                    <input type="text" id="honble_mp_action_taken" pattern="^[A-Za-z -]+$" maxlength="255" name="honble_mp_action_taken" @if(isset($ed_data->honble_mp_action_taken) ) value="{{$ed_data->honble_mp_action_taken}}" @endif class="form-control" required>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container removebg-color" style="background: #f0e7eb;padding: 10px;margin-bottom: 10px;">
                    <form action="{{ url('admin/information/information_honorable') }}" class="needs-validation" method="get" novalidate
                        autocomplete="off">
                        <div class="pageheaderr">
                            <div class="row">
                                ...
                                <div class="col-md-1 custom-buton" style="padding-top: 1.4rem;">
                                    <a class="btn btn-primary btn-sm" href="{{url('admin/information/information_honorable')}}"><i class="fas fa-refresh"></i></a>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="table-responsive" id="prodiv">
                            <table border="0" cellspacing="0" cellpadding="4" width="100%" style="border-collapse:collapse;">
                                <thead class="dn">
                                    <tr>
                                        <th colspan="2">
                                            <div style="padding: 0 15px 3px; margin-bottom: 10px;  position: relative;">
                                                ...
                                                <h2 style="text-align: center; margin:0px 0px 0px 0px; font-size:14pt; padding: 0px; color:#383838; font-weight: bold;">
                                                    मा0 सांसद एवं विधान मण्डल के मा0 सदस्यों के पत्रों पर प्रभावी एवं निश्चित कार्यवाही का प्रभावी अनुश्रवण करने विषयक सूचना
                                                </h2>
                                            </div>
                                            {{-- <h6 style="text-align: center; margin:10px 0px 15px 0px; font-size:12pt; padding: 0px; color:#383838; font-weight: bold; text-decoration:underline;">
                                                विभागाध्यक्ष- निदेषक, खेल, खेल निदेषालय, उ0प्र0, लखनऊ
                                            </h6> --}}
                                        </th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th style="font-size: 10pt; text-align:right">
                                            {{-- <strong>Report Period : </strong> {{first_insert('information_honorable','created_at')}} to {{date("d-m-Y")}} --}}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                                ...
                                                <table class="table table-bordered table-hover bg-white datatable mb-3" id="dataTable" cellpadding="3">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th>माह</th>
                                                            <th>वर्ष</th>
                                                            <th>मा0 सांसद/विधान मण्डल सदस्य का नाम</th>
                                                            <th>पत्र प्राप्त होने की तिथि</th>
                                                            <th>पत्र का विषय</th>
                                                            <th>कृत कार्यवाही का विवरण</th>
                                                            <th>मा0 सदस्य को कृत कार्यवाही से अवगत कराने की तिथि</th>
                                                            <th>मा0 सदस्य को कृत कार्यवाही से अवगत न कराये जाने का कारण</th>
                                                            <th class="noprint">Action</th>
                                                        </tr>
                                                    </thead>
                                                    @foreach($information_honorable as $key=>$item)
                                                    <tr>
                                                        <td>{{$key+1}}</td>
                                                        <td>
                                                        ...
                                                        <td>{{$item->year}}</td>
                                                        <td>{{repairHindi($item->name_of_honorable)}}</td>
                                                        <td>@if($item->date_of_receipt_of_letter)
                                                            {{dmy($item->date_of_receipt_of_letter)}}
                                                        @else NA @endif</td>
                                                        <td>{{repairHindi($item->subject_of_letter)}}</td>
                                                        <td>{{repairHindi($item->details_of_action_taken)}}</td>
                                                        <td>@if($item->date_of_informing_honble_mp)
                                                            {{dmy($item->date_of_informing_honble_mp)}}
                                                            @else NA @endif</td>
                                                        <td>{{repairHindi($item->honble_mp_action_taken)}}</td>
                                                        <td class="text-center noprint">
                                                            <a class="btn btn-sm btn-dark pointer bt" href="{{ route('information_honorable' , $item->id) }}">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        
                                                            <a class="btn btn-sm btn-danger pointer bt" href="{{ route('delete_inf' , [$item->id,'information_honorable']) }}" onclick="return confirm('Are you sure you want to delete ?')">
