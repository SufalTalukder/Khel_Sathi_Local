        ...
        <div class="card">
            <div class="card-body">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="head_office_name"  @if(isset($ed_data->head_office_name) ) value="{{repairHindi($ed_data->head_office_name)}}" @endif class="form-control" required />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="officer_name" @if(isset($ed_data->officer_name) ) value="{{repairHindi($ed_data->officer_name)}}" @endif class="form-control"
                                        required />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="placeholder">पदनाम<span
                                            class="text-danger">*</span></label>
                                    <input ttype="text" name="officer_designation" @if(isset($ed_data->officer_designation) ) value="{{repairHindi($ed_data->officer_designation)}}" @endif
                ...
                <div class="container removebg-color" style="background: #f0e7eb;padding: 10px;margin-bottom: 10px;">
                    <form action="{{ url('admin/information/nodal_officer') }}" class="needs-validation" method="get" novalidate
                        autocomplete="off">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover bg-white datatable mb-3" id="dataTable" cellpadding="3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$item->year}}</td>
                                                        <td>{{repairHindi($item->head_office_name)}}</td>
                                                        <td>
                                                        ...
                                                        <td>{{repairHindi($item->officer_name)}}</td>
                                                        <td>{{repairHindi($item->officer_designation)}}</td>
