...
<div class="row">
	...
	<div class="col-md-10">
		...
		<div class="row">
			@if(isset($is_recruitment) && ($is_recruitment == 1 && $is_directorate == 1))
			<div class="col-md-3 modulename {{$cursor_prevent}}">
			...
			@endif @if(isset($is_directorate) && $is_directorate == 1 && $is_rso == 1)
			<div class="col-md-3 modulename {{$cursor_prevent}}">
					...
					<div class="card-body p-0">
						<div class="list-group list-group-numbered">
							<a href="{{ route('laxman') }}" class="list-group-item d-flex justify-content-between align-items-start">
								...
								<span class="badge bg-primary rounded-pill">{{($list->total)}}</span> {{-- <span class="badge bg-primary rounded-pill">{{($list->total) + ($ranilaxmibai->total)}}</span> --}}
							</a>
			...
			@endif @if(isset($is_directorate) && ($is_directorate == 1 && $is_rso == 1) || $is_associate == 1 )
			<div class="col-md-3 modulename {{$cursor_prevent}}">
		...
		<div class="row">
			<div class="col-md-3">
				<a href="#" class="intentbtn bluecolor">
...
<g id="_x33_3-Theatre_seating">
		...
		c8.433,0,15.296-6.864,15.296-15.296v-32.71C213.215,238.513,206.352,231.654,197.919,231.654z" />
		...
		c8.432,0,15.295-6.864,15.295-15.296v-32.71C363.884,238.513,357.02,231.654,348.588,231.654z" />
		...
		h28.832v-28.933c0-12.092,9.364-22.032,21.217-22.965V179.71z" />
		...
		c9.617,0.756,17.594,7.442,20.263,16.395c2.669-8.952,10.645-15.639,20.263-16.395V179.71z" />
		...
		h-9.923v-16.687h44.238c8.432,0,15.294-6.859,15.294-15.294V187.9C440,179.466,433.137,172.604,424.706,172.604z" />
</g>
</svg>
                                </span>
                                <span class="intentdata"><b class="intentno">2300</b>Direct Recruitment</span></a></div>
			<div class="col-md-3">
				<a href="#" class="intentbtn pinkcolor">
                                <span class="intenticon">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"><g><path d="M98.925,91.96V94a6.92,6.92,0,0,0,13.84,0V91.96a6.92,6.92,0,1,0-13.84,0Zm10.34,0V94a3.42,3.42,0,0,1-6.84,0V91.96a3.42,3.42,0,1,1,6.84,0Z" /><path d="M22.155,85.039a6.929,6.929,0,0,0-6.92,6.921V94a6.92,6.92,0,0,0,13.84,0V91.96A6.928,6.928,0,0,0,22.155,85.039ZM25.575,94a3.42,3.42,0,0,1-6.84,0V91.96a3.42,3.42,0,1,1,6.84,0Z" /><path d="M64,81.213a8.443,8.443,0,0,0-8.433,8.433v2.632a8.433,8.433,0,0,0,16.866,0V89.646A8.443,8.443,0,0,0,64,81.213Zm4.933,11.065a4.933,4.933,0,1,1-9.866,0V89.646a4.933,4.933,0,0,1,9.866,0Z" /><path d="M126.25,16.747A1.749,1.749,0,0,0,128,15V1.747A1.749,1.749,0,0,0,126.25,0H1.75A1.749,1.749,0,0,0,0,1.747V15a1.749,1.749,0,0,0,1.75,1.75h8.844v64.23a22.145,22.145,0,1,0,28.894,32.657,28.1,28.1,0,0,0,49.022,0,22.145,22.145,0,1,0,28.9-32.661V16.747ZM3.5,3.5h121v9.75H3.5ZM10.133,114.11a7.026,7.026,0,0,1,7.009-6.725H27.169a7.025,7.025,0,0,1,7.009,6.741,18.609,18.609,0,0,1-24.045-.016Zm26.976-3.125a10.533,10.533,0,0,0-9.94-7.1H17.142A10.532,10.532,0,0,0,7.2,110.977,18.629,18.629,0,1,1,37.778,89.718a28.018,28.018,0,0,0,0,20.3Q37.457,110.515,37.109,110.985ZM47.93,118.5v-2.429a9.6,9.6,0,0,1,9.589-9.59H70.48a9.6,9.6,0,0,1,9.59,9.59V118.5a24.551,24.551,0,0,1-32.14,0Zm35.579-3.634A13.1,13.1,0,0,0,70.48,102.984H57.519a13.1,13.1,0,0,0-13.028,11.885,24.625,24.625,0,1,1,39.018,0Zm10.313-.737a7.024,7.024,0,0,1,7.009-6.747h10.027a7.026,7.026,0,0,1,7.009,6.725,18.619,18.619,0,0,1-24.045.022ZM124.5,99.868a18.535,18.535,0,0,1-3.7,11.109,10.532,10.532,0,0,0-9.938-7.092H100.831a10.533,10.533,0,0,0-9.94,7.1q-.348-.469-.669-.965a28.021,28.021,0,0,0,0-20.3A18.638,18.638,0,0,1,124.5,99.868Zm-10.594-20.63a22.094,22.094,0,0,0-25.4,6.863,28.1,28.1,0,0,0-49.019,0,22.1,22.1,0,0,0-25.4-6.858V16.747h99.812Z" /><path d="M20.344,33.748h87.312a1.749,1.749,0,0,0,1.75-1.75V24a1.749,1.749,0,0,0-1.75-1.75H20.344A1.749,1.749,0,0,0,18.594,24v8A1.749,1.749,0,0,0,20.344,33.748Zm1.75-8h83.812v4.5H22.094Z" /><path d="M20.344,50.314h87.312a1.75,1.75,0,0,0,1.75-1.75v-8a1.749,1.749,0,0,0-1.75-1.75H20.344a1.749,1.749,0,0,0-1.75,1.75v8A1.75,1.75,0,0,0,20.344,50.314Zm1.75-8h83.812v4.5H22.094Z" /><path d="M103.344,55.379H24.656a1.749,1.749,0,0,0-1.75,1.75v8a1.749,1.749,0,0,0,1.75,1.75h78.688a1.75,1.75,0,0,0,1.75-1.75v-8A1.75,1.75,0,0,0,103.344,55.379Zm-1.75,8H26.406v-4.5h75.188Z" /></g></svg>
</span>
<span class="intentdata"><b class="intentno">2000</b>Financial Assistance</span></a></div>
			<div class="col-md-3">
				<a href="#" class="intentbtn yellowcolor">
                                <span class="intenticon">
                                ...
                                </span><span class="intentdata"><b class="intentno"> 300</b> Monthly Pension</span></a></div>


			<div class="col-md-3"> <a href="#" class="intentbtn greencolor"> <span class="intenticon">
				...
				</span> <span class="intentdata"> <b class="intentno">340</b> Nomination for Laxman Award</span></a></div>
			<div class="col-md-3">
				<a href="#" class="intentbtn box5color">
                                <span class="intenticon">
                                    <svg fill="#ffffff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g data-name="Layer 2"> <g data-name="award"> <rect width="24" height="24" opacity="0"></rect> <path d="M19 20.75l-2.31-9A5.94 5.94 0 0 0 18 8 6 6 0 0 0 6 8a5.94 5.94 0 0 0 1.34 3.77L5 20.75a1 1 0 0 0 1.48 1.11l5.33-3.13 5.68 3.14A.91.91 0 0 0 18 22a1 1 0 0 0 1-1.25zM12 4a4 4 0 1 1-4 4 4 4 0 0 1 4-4z"></path> </g> </g> </g></svg>
                                </span> <span class="intentdata"> <b class="intentno">350</b> Nomination for Rani Laxmibai Award</span></a></div>

			<div class="col-md-3">
				<a href="#" class="intentbtn box6color">
                                <span class="intenticon">
                                ...
                                </span><span class="intentdata"><b class="intentno">50</b>Nomination for Prize Money</span></a></div>
