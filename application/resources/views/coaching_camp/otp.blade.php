...
@section('content')
    ...
    <div class="p-4 p-lg-5 login-form">
                 ...
                 <form action="{{ route('coaching_camp_otpStore') }}" class="mt-4" method="POST" id="submitform">
                    @csrf
                     ...
                     <div class="d-flex justify-content-center align-items-center mt-2 text-center mb-3">
                         <span class="fw-normal text-black-50"><span class="otp-time"><br>
...
$(".otpresend434").on("click", function () {
        $.ajax({
            type: "GET",
            url: ajaxUrl + "/coaching_camp/resend_otp",
            dataType: "json",
