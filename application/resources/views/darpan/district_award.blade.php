						...
						<table  id="dataTable" class="table table-striped table-bordered datatable">
							...
							<tbody>
								...
								<tr>
                                    <td>{{$key + 1}}</td>
									<td>{{$list->district}}</td>
									<td align="center" ><a href="{{ url('darpan/award/'.$list->district) }}">{{$list->total}}</a></td>

									<td align="center"><a  class="total_pending" href="{{ url('darpan/award/1/'.$list->district) }}">{{$list->total_pending}}</a></td>
									<td align="center"><a href="{{ url('darpan/award/2/'.$list->district) }}">{{$list->total_accepted}}</a></td>
									<td align="center"><a href="{{ url('darpan/award/3/'.$list->district) }}">{{$list->total_rejected}}</a></td>
