...
@section( 'content' )
		...
		<h4 class="mb-0">List of Direct Recruitment Applicant
			...
			<a  title="List of  Direct Recruitment Applicant" class="btn btn-sm btn-success ms-2 float-end" onclick="ExportToExcel('List of  Direct Recruitment Applicant','xlsx')">
