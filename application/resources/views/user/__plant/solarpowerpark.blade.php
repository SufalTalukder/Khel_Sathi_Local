                            ...
                            <div class="profile-head">
                                ...
                                <div class="tab-content profile-tab" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <form action="{{ route('powerprojectpublicpark') }}" method="post" id="reloadSolar" class="needs-validation" enctype="multipart/form-data" novalidate="">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="form-control btn-group">
                                                            ...
                                                            <div class="custom-control custom-radio">
                                                                <input value="1" type="radio" class="custom-control-input" id="customControlValidation2" name="approval_of_park" required  checked >
                                                            ...
                                                            <div class="custom-control custom-radio" style="margin-left:5px;">
                                                                <input value="2" type="radio" class="custom-control-input" id="customControlValidation3" name="approval_of_park" required >
