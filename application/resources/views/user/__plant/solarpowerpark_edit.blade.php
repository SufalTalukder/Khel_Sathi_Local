...
<div class="row">
    ...
    <div class="col-10">
        <div class="col-md-12 pageheader mb-0">
            <div class="row">
                <div class="col-md-12">
                    <h4>Solar Power Park Public Sector</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Solar Power Park Public Sector</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="profile-head">
                                ...
                                <div class="tab-content profile-tab" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <form action="{{ url('powerProjectPublicParkUpdate') }}" method="post" id="reloadSolar" class="needs-validation" enctype="multipart/form-data" novalidate="">
                                        <input type="hidden" value="{{ $items->id }}" name="rowid" id="rowid">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        <label for="username" class="placeholder">Have you received any approval of Park from Government of India <span class="text-danger">*</span></label>
                                                        <div class="form-control btn-group">



                                                            <div class="custom-control custom-radio">
                                                                <input value="1" type="radio" class="custom-control-input" id="customControlValidation2" name="approval_of_park" required @if($items->approval_of_park=='') checked @endif @if($items->approval_of_park=='Yes') checked @endif>
                                                            ...
                                                            <div class="custom-control custom-radio" style="margin-left:5px;">
                                                                <input value="2" type="radio" class="custom-control-input" id="customControlValidation3" name="approval_of_park" required @if($items->approval_of_park=='No') checked @endif>
                                                                <label class="custom-control-label" for="customControlValidation3">No</label>
                                                                <div class="invalid-feedback">Please provide a type</div>
                                                            </div>


                                                            <!-- <label class="me-3 mb-0"><input class="form-control" required type="radio" name="pubpark" @if($items->approval_of_park=='Yes') checked @endif > Yes</label>
                                                            <label class="mb-0"><input required type="radio" name="pubpark" @if($items->approval_of_park=='No') checked @endif > No</label> -->
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="bhoechie-footer">
                                        <div class="row justify-content-center">
                                            <div class="col-md-2 d-grid">
                                                <!-- <button type="button" class="btn btn-primary" onclick="show2()">Submit/दर्ज करे</button> -->
