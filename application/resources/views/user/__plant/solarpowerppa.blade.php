                            ...
                            <div class="profile-head">
                                ...
                                <div class="tab-content profile-tab" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <form action="{{ route('powerprojectppa') }}" method="post" id="reloadSolar" class="needs-validation" enctype="multipart/form-data" novalidate>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select class="form-control" id="preference_second" name="preference_second" required>
                                                            <option value="">Select</option>
                                                            @foreach($state as $item)
                                                            <option value="{{ $item->id }}" >{{ $item->name}}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select class="form-control" id="preference_third" name="preference_third" required>
                                                            <option value="">Select</option>
                                                            @foreach($state as $item)
                                                            <option value="{{ $item->id }}" >{{ $item->name}}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="area_of_land" name="area_of_land" required>
                                                    </div>
                                                </div>
                                            </div>
