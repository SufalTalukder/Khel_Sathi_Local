            ...
            <div class="p-3 bg-white">
                    ...
                    <tr>
                        <td colspan="2" align="center" style="position: relative; border: 0; padding-bottom: 5px;">
                            <div style="border-bottom: 0px solid #000; padding-bottom: 2vw;">
                                ...
                                <div style="font-size: 18px; font-weight: bold;">Application for Nomination for Laxman
                                    Award/लक्ष्मण पुरस्कार के लिए नामांकन हेतु आवेदन </div>
                                <div style="font-size: 18px; font-weight: bold;">वित्तीय वर्ष 2025-26 में लक्ष्मण पुरस्कार
                                    2024-25 हेतु आवेदन पत्र</div>
                ...
                @foreach ($articles as $article)
                    ...
                    <div class="table-responsive">
                        <table id="dataTable" class="table table-bordered" border="1"
                            ...
                            <tr>
                                ...
                                <td colspan="2" rowspan="4"><b>Applicant’s Photo<br>आवेदक की फोटो</b><br />
                            ...
                            <tr>
                                ...
                                @if ($article->highschool_certificate != '')
                                    ...
                                    <td>
                                        <a download
                                            href="{{ url('storage/laxman_award', $article->highschool_certificate) }}"
                                            target="_blank">
					...
					<td>{{$article->permanent_flat_no}}</td> --}}
                            ...
                            <tr>
                                <td colspan="2"><b>Mobile No. (registered with Bank Account)<br>मोबाइल नंबर (बैंक खाते के
                                        साथ जो पंजीकृत है)</b>
                                </td>
                                <td>{{ $article->mobile_registered_in_bank }}</td>
                                <td colspan="2"><b>Any other relevant information applicant wants to specify?<br>कोई अन्य
                            ...
                            <tr>
                                <td colspan="6">
                                    <table class="table table-bordered table-sm awardtable">
                                        <thead>
                                            <tr>
                                                <td rowspan="2"><label>Sports Competition Name <br>खेलकूद
                                                        प्रतियोगिता का नाम</label> <span class="text-danger">*</span>
                                                </td>
                                                <td rowspan="2"><label>Sport Name<br>खेल का नाम</label> <span
                                                        class="text-danger">*</span>
                                                </td>
                                                <td rowspan="2"><label>Position<br>पद का नाम</label>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:center">
                                                        @if ($item->sport_achievement_docs != '')
                                                            ...
                                                            <a href="{{ url('storage/laxman_award', $item->sport_achievement_docs) }}"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        @if ($item->achievement_docs != '')
                                            <a download
                                                href="{{ url('storage/laxman_award', $item->achievement_docs) }}"
                                                target="_blank">
                                                <!-- <span class="btn btn-success btn-xs">Uploaded</span> -->
                                                <i class="fa fa-download"></i>
                                            </a>
                            ...
                            <tr>
                                <td><b>Certificate of Highest Educational Qualification<br>उच्चतम शैक्षणिक योग्यता का
                                        प्रमाणपत्र अपलोड करें</b>
                                </td>
                                <td>
                                    @if ($article->qualification_doc != '')
                                        <a download
                                            href="{{ url('storage/award', $article->qualification_doc) }}"
                                            target="_blank">
                                            <!-- <span class="btn btn-success btn-xs">Uploaded</span> -->
                                            <i class="fa fa-download"></i>
                                ...
                                <td>
                                    @if ($article->domicile_certificate != '')
                                        <a download
                                            href="{{ url('storage/laxman_award', $article->domicile_certificate) }}"
                                            target="_blank">
                                            <!-- <span class="btn btn-success btn-xs">Uploaded</span> -->
                                            <i class="fa fa-download"></i>
                                        </a>
                                ...
                                <td>
                                    @if ($article->notary_affidavit_doc != '')
                                        <a download
                                            href="{{ url('storage/laxman_award', $article->notary_affidavit_doc) }}"
                                            target="_blank">
                                            <!-- <span class="btn btn-success btn-xs">Uploaded</span> -->
                                            <i class="fa fa-download"></i>
                                        </a>
    ...
    @endif
                            ...
                            <tr>
                                ...
                                <td colspan="4">Have you ever been convicted for consuming drugs during any
                                    Competition/Championship?<br>क्या आपको कभी किसी प्रतियोगिता/चैंपियनशिप के दौरान नशीली
                                    दवाओं के सेवन के लिए दोषी ठहराया गया है?</td>
                            </tr>
                            <tr>
                                <td align="center">
                                ...
                                <td align="center">
                                    <input name="court_case" value="2"
                                        {{ $article->final_submit == 1 ? 'disabled' : '' }}
                                        {{ $article->court_case == 2 ? 'checked' : '' }} class="court_case"
                                        type="radio" /> &nbsp; <b>No/नहीं</b>
                                </td>
                                <td colspan="4">Have you ever been convicted by a Court of Law in any Case/Sexual
                                    Harassment?<br>क्या आपको कभी किसी न्यायालय द्वारा किसी मामले/यौन उत्पीड़न में दोषी
                                    ठहराया गया है?</td>
                            </tr>
                            <tr>
                                <td colspan="1" align="center">
                                    <input {{ $article->final_submit == 1 ? 'disabled' : '' }}
                                        {{ $article->final_submit == 1 ? 'checked' : '' }} type="checkbox"
                                        id="checkbox" /> &nbsp; <b>I Agree/मैं सहमत हूं</b>
                                </td>
                                <td colspan="5">I hereby declare that I have read all terms & conditions, eligibility
                                    criteria and other relevant information related to the Application and abide by them. I
                                    also declare that all the above particulars are true to the best of my knowledge. If any
                                    of my facts are found to be wrong or incorrect, my application shall be liable for
                                    rejection and I shall be solely held responsible for it.<br>मैं एतद्द्वारा घोषणा
                                    करता/करती हूं कि मैंने आवेदन से संबंधित सभी नियम और शर्तें, पात्रता मानदंड और अन्य
                                    प्रासंगिक जानकारी पढ़ ली हैं एवं उनका पालन करता/करती हूं। मैं यह भी घोषणा करता/करती हूं
                                    कि उपरोक्त सभी विवरण मेरे अनुसार सत्य व सही हैं। यदि मेरा कोई भी तथ्य गलत अथवा असत्य
                                    पाया जाता है, तो मेरा आवेदन अस्वीकृत किया जा सकता है और इसके लिए पूर्णतः मैं स्वयं
                                    उत्तरदायी ठहराया जाऊंगा/जाऊंगी।
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" align="center">
                                    <span>Application Submitted On<br>आवेदन दर्ज करने की तिथि </span><br>
                            ...
                            <tr>
                                <td colspan="6" align="center">
                                    @if ($article->final_submit != 1 || $article->is_editable != 2)
                                        ...
                                        <a href="Javascript:void(0)" class="btn btn-info me-3" id="check1">Final
                                            Submit/अंतिम रूप से दर्ज करें</a>
                                    @endif
                        ...
                        @else
                            @if ($article->final_submit != 1 || $article->is_editable != 2)
                                <a href="{{ url('edit_laxman_award') }}/{{ $article->application_no }}"
                                    class="btn btn-primary btn-sm noprint">
                                    Edit/संशोधन करें
                                </a>
                            @endif
                @endif
...
@push('custom-scripts')
    <script>
        ...
        $('#check1').click(function() {
            ...
            content.innerHTML =
                '<h3>Please click on the Declaration Checkbox and then proceed to submit. कृपया घोषणा के चेकबॉक्स पर क्लिक करें एवं तदोपरांत अंतिम रूप से दर्ज करें।</h3>';
        ...
        $("#final_submit").click(function(e) {
            ...
            var actionUrl = ajaxUrl + "/finalSubmit_laxman_award/" + application_no;
