                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="bhoechie-tab-content">
                        <div class="form-scroll">
                            <form action="{{url('/update_laxman_award')}}" method="post" enctype="multipart/form-data"  id="ajxReload"  class="needs-validation" novalidate="">
                                @csrf
                                <div>
                                    <div class="row">
                                        @foreach($laxman_award as $item)
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @php
                                                    $img = url('storage/laxman_award').'/'.$item->qualification_doc;
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @php
                                                    $img = url('storage/laxman_award').'/'.$item->domicile_certificate;
                                                    $img1 = url('public/images/view.jpg');
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @php
                                                    $img = url('storage/laxman_award').'/'.$item->highschool_certificate;
                                                    $img1 = url('public/images/view.jpg');
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                    <table class="table table-bordered" id="dynamic_field">
                                                        <thead>
                                                            <tr>
                                                                <td rowspan="2"><label>Sports Competition Name <br>खेलकूद प्रतियोगिता का नाम<span class="text-danger">*</span></label> </td>
                                                                <td rowspan="2"><label>Sport Name<br>खेल का नाम<span class="text-danger">*</span></label></td>
                                                                <td rowspan="2"><label>Position / Medal<br>पद का नाम / पदक<span class="text-danger">*</span></label></td>
                                                                <td colspan="2" class="text-center"><label>Period of Competition<br>प्रतियोगिता की अवधि<span class="text-danger">*</span></label> </td>
                                                                <td rowspan="2"><label>Venue Name</br>स्थल का नाम<span class="text-danger">*</span</label> </td>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><input type="text" required value="{{old('sport_name[]') }}" name="sport_name[]" placeholder="Sports Name" class="form-control name_email"></td>
                                                        ...
                                                        @foreach( $sport_achievement as $key=>$post)
                                                            <tr id="row{{$key}}">
                                                                ...
                                                                <td>
                                                                    <select class="form-select sport_type" style="pointer-events: none;" name="sport_name[]" required>
                                                                        <option value="">Select</option>
                                                                        @foreach ($sport_type as $type)
                                                                        <option value="{{$type->id}}" {{ $selected_sport==$type->id ? 'selected' : '' }} {{ old('sport_type') === $type->id ? 'selected' : '' }}>{{$type->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    <!-- <input type="text" required value="{{$post->sport_achievement_name}}" name="sport_name[]" placeholder="Sports Name" class="form-control name_email"> -->
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <input type="text" id="doc{{$key}}" class="form-control firstDate dateTimeee" onchange="checkDate({{$key}})" onpaste="return false;" ondrop="return false;" onkeypress="return false" autocomplete="off" required value="{{$post->competition_from_date}}" name="competition_from_date[]" data-language="en" placeholder="dd-mm-yyYY" required>
                                                                </td>
                                                                <td><input type="text" id="{{$key}}to" class="form-control to-to-to dateTimeee" onchange="checkDate({{$key}})" onpaste="return false;" ondrop="return false;" onkeypress="return false" autocomplete="off" required value="{{$post->competition_to_date}}" name="competition_to_date[]" data-language="en" placeholder="dd-mm-yyYY" required></td>
                                                                ...
                                                                <td>
                                                                    <div class="input-group">
                                                                        ...
                                                                        @php
                                                                        $img = url('storage/laxman_award').'/'.$post->sport_achievement_docs;
                                                                        $img1 = url('public/images/view.jpg');
                                            ...
                                            <div class="form-group">
                                                <table class="table table-bordered" id="dynamic_field3">
                                                    <thead>
                                                        <tr>
                                                            <td><b>Name/नाम</b></td>
                                                            <td><b>Docs/दस्तावेज <span class="note">(File Format: Pdf | Max File Size: 2 MB)/(फाइल का प्रारूप: PDF | फाइल का अधिकतम साइज़: 2 MB)</span></b></td>
                                                            <td></td>
                                                        </tr>
                                                    </thead>
                                                    ...
                                                    @foreach( $other_achievement as $key=>$post)
                                                        ...
                                                        <tr id="row{{$key}}">
                                                            <td><input type="text" value="{{$post->achievement_name }}" name="other_achievement_name[]" placeholder="Sports Achievements" class="form-control name_email"></td>
                                                            <td>
                                                                <div class="input-group">
                                                                    ...
                                                                    @php
                                                                    $img = url('storage/laxman_award').'/'.$post->achievement_docs;
                                                                    $img1 = url('public/images/view.jpg');
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="hidden" value="{{ isset($item->notary_affidavit_doc)  ? $item->notary_affidavit_doc : old('notary_affidavit_doc')  }}" name="notary_affidavit_doc1">
                                                    ...
                                                    @php
                                                    $img = url('storage/laxman_award').'/'.$item->notary_affidavit_doc;
                                                    $img1 = url('public/images/view.jpg');
...
<script>
    $(document).ready(function() {
        ...
        $("#doc").change(function(){
            ...
            if(checkkk==0){
            $("#to").datepicker( { changeMonth: true, changeYear: true, minDate: start,yearRange: yrRange,maxDate: '0',dateFormat: 'dd-mm-yy' });
            }else{
