                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" onkeypress="return false" autocomplete="off" required @if(isset($iso_detail) && $iso_detail->dob) class="form-control " readonly  value="{{isodate($iso_detail->dob)}}" @else value="{{old('dob') ? old('dob') : $user->dob}}" id="dob" @endif class="form-control" name="dob" data-language="en" placeholder="DD/MM/YYYY">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required @if(isset($iso_detail) && $iso_detail->aadhar_reference_no) value="" class="form-control dis_check" @endif class="form-control" pattern="[0-9]{12}" name="aadhar_no" maxlength="12" minlength="12" value="{{old('aadhar_no') ? old('aadhar_no') : $user->aadhar_no}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    @if($user->aadhar_doc !='')
                                    @php
                                    $img = url('storage/app/public/award').'/'.$user->aadhar_doc;
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <br><span>अधिकृत संस्था द्वारा निर्गत जन्म प्रमाण पत्र (नगर पंचायत/नगर निगम/नगर पालिका) /  Birth Certificate issued by an authorized institution(Nagar Panchayat/Municipal Corporation/Municipality)</span></label>
                                <div class="input-group">
                                    ...
                                    @php
                                    $img = url('storage/app/public/award').'/'.$user->birth_certificate;
                                    $img1 = url('public/images/view.jpg');
                        ...
                        <div class="col-md-6" id="physical_condition_hide_div">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    @php
                                    $img = url('storage/app/public/award').'/'.$user->phy_handi_docs;
                                    $img1 = url('public/images/view.jpg');
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    @php
                                    $img = url('storage/app/public/award').'/'.$user->photograph_doc;
                                    $img1 = url('public/images/view.jpg');
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    @php
                                    $img = url('storage/app/public/award').'/'.$user->signature_doc;
                                    $img1 = url('public/images/view.jpg');
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="form-select  @if(isset($iso_detail) && $iso_detail->residential_state) dis_check @endif" required name="present_state" readonly id="state1" onchange="get_city(this.value,'district1')">
                                    <option value="">Select</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="form-select dis_check " required name="permanent_district" id="district">
                                    <option value="">Select</option>
                                    @foreach($all_city as $value)
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" pattern="[0-9]{6}" minlength="6" maxlength="6" name="permanent_pincode" id="permanent_pincode" @if(isset($iso_detail) && $iso_detail->permanent_pin ) class="form-control dis_check" value="{{ $iso_detail->permanent_pin}}" @else value="{{old('permanent_pincode') ? old('permanent_pincode') : $user->permanent_pincode}}" @endif class="form-control dis_check">
                            </div>
                        </div>
                    </div>
