		...
		<div class="bhoechie-tab-container">
			<div class="bhoechie-tab-content">
				<div class="form-scroll">
					<form action="{{url('/save_laxman_award')}}" method="post" enctype="multipart/form-data" id="ajxReload" class="needs-validation" novalidate="">
						@csrf
						<div id="twoCarDiv" class="desc">
							<div class="row">
								<div class="col-md-12">
									<h5 class="subheading">Nomination Form for Laxman Award/लक्ष्मण पुरस्कार हेतु नामांकन</h5>
								</div>
								<!-- basic Detail -->
								<div class="col-md-3">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="placeholder">1. Which Sport did/do you play?<br>कौन सा खेल खेलते थे/हैं?<span class="text-danger">*</span></label>
								...
								@if ($selected_sport == 52)
								
								<div class="col-md-6">
									<div class="form-group">
										<label>Para Sports Sub-category?<br>पैरा स्पोर्ट्स उप-श्रेणी?</label>
										<div class="input-group">
											<input type="text" class="form-control" value="{{$user->para_sport}}" readonly>
										</div>
									</div>
								</div>
								@endif
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control form-select dropdown" required id="qualification" name="qualification">
											...
											<option {{ old( 'qualification')==="post_graduation " ? 'selected' : '' }} value="post_graduation">Post-Graduation </option>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="input-group">
											<input type="file" name="qualification_doc" class="form-control" onchange="getfileextp(this.value,1)" id="File1" aria-describedby="inputGroupFileAddon05" aria-label="Upload" required>
										</div>
										<span class="note">(File Format/फाइल का प्रारूप: PDF | Max File Size/फाइल का अधिकतम साइज़: 2 MB)</span>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="input-group">
											<input type="file" value="{{old('domicile_certificate') }}" name="domicile_certificate" class="form-control" onchange="getfileextp(this.value,2)" id="File2" aria-describedby="inputGroupFileAddon05" aria-label="Upload" required>
										</div>
										<span class="note">(File Format/फाइल का प्रारूप: PDF | Max File Size/फाइल का अधिकतम साइज़: 2 MB)</span>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="input-group">
											<input type="file" value="{{old('highschool_certificate') }}" name="highschool_certificate" class="form-control" onchange="getfileextp(this.value,6)" id="File6" aria-describedby="inputGroupFileAddon05" aria-label="Upload" required>
										</div>
										<span class="note">(File Format/फाइल का प्रारूप: PDF | Max File Size/फाइल का अधिकतम साइज़: 2 MB)</span>
									</div>
								</div>
								@endif
								<div class="col-md-12">
									<h5 class="subheading">1. Sports Achievements/खेल क्षेत्र में उपलब्धियां (प्रमाण-पत्र राज्य खेल संघ/एसोसिएशन के सचिव/महासचिव के हस्ताक्षर से प्रमाणित होने चाहिए)</h5>
								</div>
										...
										<table class="table table-bordered" id="dynamic_field">
											<thead>
												<tr>
													...
													<td rowspan="2"><label>Upload Relevant Certificate<br>प्रासंगिक प्रमाण पत्र अपलोड करें<span class="text-danger">*</span><br><span class="note">(File Format/फाइल का प्रारूप: PDF | Max File Size/फाइल का अधिकतम साइज़: 2 MB)</span>
														</label>
													</td>
											...
											<tbody>
												<tr>
													...
													<td>
														<select class="form-select sport_type" name="sport_name[]" required>
															<option value="">Select</option>
															@foreach ($sport_type as $type)
															<option value="{{$type->id}}" {{ $selected_sport==$type->id ? 'selected' : '' }} >{{$type->name}}</option>
															@endforeach
														</select>
													</td>
								...
								<div class="col-md-12">
									<h5 class="subheading">2. Other Achievements/अन्य उपलब्धियां</h5>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										<table class="table table-bordered" id="dynamic_field3">
											<thead>
												<tr>
													...
													<td><b>Relevant Document/प्रासंगिक दस्तावेज</b><br><span class="note">(File Format/फाइल का प्रारूप: PDF | Max File Size/फाइल का अधिकतम साइज़: 2 MB)</span>
													</td>
													<td></td>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td><input type="text" value="{{old('other_achievement_name[]') }}" name="other_achievement_name[]" placeholder="Other Achievements" class="form-control name_email">
													</td>
													<td>
														<div class="input-group">
															<input type="file" name="other_achievement_docs[]" class="form-control" onchange="getfileextp(this.value,4)" id="File4" aria-describedby="inputGroupFileAddon05" aria-label="Upload">
														</div>
													</td>
													<td><button type="button" name="add" id="add3" class="btn btn-primary mt-1">Add</button>
													</td>
												</tr>
											</tbody>
										</table>
								...
								<div class="col-md-4">
									<div class="form-group">
										<label class="placeholder">6. PAN <br>स्थायी खाता संख्या<span class="text-danger">*</span></label>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" value="{{old('other_relevant_information_applicant') }}" name="other_relevant_information_applicant" class="form-control">
									</div>
								</div>
								<div class="col-md-4">
                                            <div class="form-group mb-3">
                                                <label class="placeholder">9. Upload Notary Affidavit
                                                    <br> नोटरी शपथ पत्र अपलोड करें
                                                <span class="text-danger">*</span>
                                                    <a download href="{{url('public/award/Laxman-RLB-notari.pdf')}}"><span class="text-danger">Sample File</span></a>
												</label>
                                                <div class="input-group">
                                                <input name="notary_affidavit_doc" onchange="getfileextp(this.value,1044)" id="File1044" class="form-control" type="file" id="formFile" {{ isset($item->notary_affidavit_doc)  ? '': 'required'  }}>
...
<script>
	$(document).ready(function() {
		...
		$("#add3").click(function() {
			...
			// console.log( 'amount: ' + addamount );
			i++;
			$('#dynamic_field3').append('<tr id="row' + i + '"><td><input type="text" name="other_achievement_name[]" required placeholder="Other Achievements" class="form-control name_email"/></td><td><div class="input-group"><input type="file" required name="other_achievement_docs[]" class="form-control"  onchange="getfileextp(this.value,3' + i + ')" id="File3' + i + '" aria-describedby="inputGroupFileAddon05" aria-label="Upload"></div></td><td><button type="button" name="remove" id="' + i + '" class="btn btn-danger mt-1 px-2 btn_remove"><span class="far fa-trash-alt"></span></button></td></tr>');
		});
		$(document).on('click', '.btn_remove', function() {
			addamount -= 700;
			// console.log( 'amount: ' + addamount );
