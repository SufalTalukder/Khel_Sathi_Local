...
@section( 'content' )
		...
		<div class="pageheader" id="menu-margin">
			<h4 class="mb-0"> List of Hostel Applicant<!-- <a class="btn btn-sm btn-success" href="{{ route('exportExcel',5) }}"> -->
				...
				<a title="Application Details ExportToExcel" class="btn btn-sm btn-success float-end" href="{{route('download_hostel_pdf',4)}}">
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="mb-4">
					<form class="row" method="post" action="{{ route('hosteladminmedical_test') }}">
                        @csrf
						<div class="col-md-1">
                        ...
                        <div class="col-md-2">
							<label for="medical_approval_filter">Status</label>
							<select class="form-control" name="medical_approval_filter" onchange="fetchone()">
								<option value="">--All--</option>
								<option value="1" {{request()->input('medical_approval_filter') == 1 ? 'selected' : ''}}>Approved</option>
								<option value="2" {{request()->input('medical_approval_filter') == 2 ? 'selected' : ''}}>Pending</option>
							</select>
						</div>
                        ...
                        <div class="col-md-1">
							<label for="reset">&nbsp;</label>
							<a href="{{ route('hosteladminmedical_test') }}" class="btn btn-success  btn-block">
					      	Reset
                            </a>
						</div>
                        <div class="col-md-1">
...
$.ajax({
        type: "POST",
data:{arr},
        url: ajaxUrl + '/hosteladmin/medical_test_approved',
        dataType: "json",
