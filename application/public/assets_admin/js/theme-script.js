...
$(document).ready(function(){
	if (window.innerWidth < 767) {
		$(".contentwraper").removeClass("menumarginleft");
		$(".menusidebar").removeClass("menusidebar-width");
		$(".header").removeClass("menuheader-width");
		
	} else {
		$(".contentwraper").addClass("menumarginleft");
		$(".menusidebar").addClass("menusidebar-width");
		$(".header").addClass("menuheader-width");
	}
});
