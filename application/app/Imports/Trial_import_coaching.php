...
class Trial_import_coaching implements ToCollection
{
    /**
                ...
                if ($user) {
                    ...
                    if ($item[12] >= 20) {
                        DB::table('hostel_register')->where('id', $user->id)->update([
                            ...
                            'physical_trial_one_marks' =>$item[12],
                            ...
                            'trial_four' => 2,
                            'physical_trial_four_marks' => $item[12],
                        ...
                        if ($item[0] == 1) {
                            ...
                            if ($item[19] >= 25) {
                                DB::table('hostel_register')->where('id', $user->id)->update([
                                    ...
                                    'trial_four' => 2,
                                    'skill_trial_four_marks' => $item[19],
                                ]);
                            } elseif ($item[19] < 25) {
                                DB::table('hostel_register')->where('id', $user->id)->update([
                           ...
                           $id = DB::table('hostel_volleyball_trial')->insertGetId($data);
                            ...
                            if ($item[17] >= 25) {
                                DB::table('hostel_register')->where('id', $user->id)->update([
                                    ...
                                    'trial_four' => 2,
                                    'skill_trial_four_marks' => $item[17],
                            ...
                            if ($item[21] >= 25) {
                                DB::table('hostel_register')->where('id', $user->id)->update([
                                    ...
                                    'trial_four' => 2,
                                    'skill_trial_four_marks' => $item[21],
                   ...
                   $data['trial_type'] = 4;
                            ...
                            if ($item[20] >= 25) {
                                DB::table('hostel_register')->where('id', $user->id)->update([
                                    ...
                                    'trial_four' => 2,
                                    'skill_trial_four_marks' => $item[20],
                   ...
                   $data['trial_type'] = 4;
                            ...
                            if ($item[22] >= 25) {
                                DB::table('hostel_register')->where('id', $user->id)->update([
                                    ...
                                    'skill_trial_one_marks' => $item[22],

                                    'trial_two' => 2,

                                    'skill_trial_two_marks' => $item[22],
                                    'trial_three' => 2,
                                    'skill_trial_three_marks' => $item[22],

                                    'trial_four' => 2,
                                    'skill_trial_four_marks' => $item[22],
                                ]);
                            } elseif ($item[22] < 25) {
                                DB::table('hostel_register')->where('id', $user->id)->update([
